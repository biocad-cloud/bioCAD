...
$ts("<div>"),e=a.cloneNode(!0);if("svg"==a.tagName){var g=b.width||d.getDimension(a,e,"width");var m=b.height||d.getDimension(a,e,"height")}else if(a.getBBox){var p=a.getBBox();g=p.x+p.width;m=p.y+p.height;e.setAttribute("transform",e.getAttribute("transform").replace(/translate\(.*?\)/,""));p=document.createElementNS("http://www.w3.org/2000/svg","svg");p.appendChild(e);e=p}else{console.error("Attempted to render non-SVG element",a);return}e.setAttribute("version","1.1");e.getAttribute("xmlns")||
e.setAttributeNS(d.xmlns,"xmlns","http://www.w3.org/2000/svg");e.getAttribute("xmlns:xlink")||e.setAttributeNS(d.xmlns,"xmlns:xlink","http://www.w3.org/1999/xlink");b.responsive?(e.removeAttribute("width"),e.removeAttribute("height"),e.setAttribute("preserveAspectRatio","xMinYMin meet")):(e.setAttribute("width",(g*b.scale).toString()),e.setAttribute("height",(m*b.scale).toString()));e.setAttribute("viewBox",[b.left||0,b.top||0,g,m].join(" "));p=e.querySelectorAll("foreignObject > *");for(var n=0;n<
p.length;n++)p[n].getAttribute("xmlns")||p[n].setAttributeNS(d.xmlns,"xmlns","http://www.w3.org/1999/xhtml");f.appendChild(e);d.styles.doStyles(a,b,function(a){a=$ts("<style>",{type:"text/css"}).display("<![CDATA[\n"+a+"\n]]\x3e");a=$ts("<defs>").display(a);e.insertBefore(a,e.firstChild);c&&(a=f.innerHTML,a=a.replace(/NS\d+:href/gi,'xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href'),c(a,g,m))})};b.svgAsDataUri=function(a,b,c){void 0===c&&(c=null);this.prepareSvg(a,b,function(a){a="data:image/svg+xml;base64,"+
