...
enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"type",{get:function(){return"input"==this.tagName.toLowerCase()?this.First.type:this.tagName},enumerable:!0,configurable:!0});e.ensureElements=function(c){var b=$ts.typeof(c);if("NodeList"==b.class){var a=[];c.forEach(function(f){return a.push(f)})}else if("HTMLCollection"==b.class)for(a=[],b=0;b<c.length;b++)a.push(c.item(b));else a=Framework.Extensions.EnsureArray(c);c=0;for(b=a;c<b.length;c++)TypeExtensions.Extends(b[c]);return a};
...
(function(d){(function(e){(function(c){c.getElementByIdUnderContext=function(b,a){return a instanceof Window?a.document.getElementById(b):a.getElementById(b)};c.selectElementsUnderContext=function(b,a){return a instanceof Window?a.document.querySelector(b.expression):a.querySelector(b.expression)}})(e.Selector||(e.Selector={}))})(d.Handlers||(d.Handlers={}))})(Internal||(Internal={}));
...
function(a,f){void 0===f&&(f=window);a=a.replace(":","\\:");if(f instanceof Window)f=f.document.querySelectorAll(a);else if(f instanceof HTMLElement)f=f.querySelectorAll(a);else throw"Unsupported context type: "+TypeScript.Reflection.getClass(f);return new DOMEnumerator(f)};f.prototype.doEval=function(a,b,g){var c=DOM.Query.parseQuery(a);b=f.ensureArguments(g);var d=b.context||window;if(c.type==DOM.QueryTypes.id)return g=e.Selector.getElementByIdUnderContext(c.expression,d),isNullOrUndefined(g)?(TypeScript.logging.outputWarning&&
console.warn("Unable to found a node which its ID='"+a+"'!"),null):b.nativeModel?TypeExtensions.Extends(g):new HTMLTsElement(g);if(c.type==DOM.QueryTypes.NoQuery)return f.createNew(a,b,d);if(c.singleNode){if(c.type==DOM.QueryTypes.QueryMeta)return DOM.InputValueGetter.metaValue(c.expression,(g||{})["default"],d!=window);TypeScript.logging.outputEverything&&console.warn("Apply querySelector for expression: '"+c.expression+"', no typescript extension was made!");a=e.Selector.selectElementsUnderContext(c,
d);return isNullOrUndefined(a)?null:b.nativeModel?TypeExtensions.Extends(a):new HTMLTsElement(a)}return c.type==DOM.QueryTypes.class?(a=document.getElementsByClassName(c.expression),new DOMEnumerator(a)):f.select(c.expression,d)};f.createNew=function(b,g,c){void 0===c&&(c=window);b=DOM.ParseNodeDeclare(b);var e=c.document.createElement(b.tag);b.attrs.forEach(function(f){0>a.indexOf(f.name)&&e.setAttribute(f.name,f.value)});g&&f.setAttributes(e,g);return g.nativeModel?TypeExtensions.Extends(e):new HTMLTsElement(e)};
f.setAttributes=function(f,g){var c=function(b){if(!(-1<a.indexOf(b)))if("class"==b){var c=g[b];Array.isArray(c)?c.forEach(function(a){return f.classList.add(a)}):f.setAttribute(b,c)}else if("style"==b)if(c=g[b],"string"==typeof c)f.setAttribute(b,c);else for(var e in c)f.style[e]=c[e];else if("visible"==b)f.style.display=g[b]?"block":"none";else{c=g[b];if("src"==b||"href"==b)c=d.urlSolver(c);f.setAttribute(b,c)}};d.Arguments.nameFilter(g).forEach(function(a){return c(a)});this.hookEvt(f,b.onclick,
g);this.hookEvt(f,b.onmouseover,g);this.hookEvt(f,b.onchange,g)};f.hookEvt=function(a,f,g){if(c(g,f)){var e=g[f];if("string"==typeof e)a.setAttribute(f,e);else switch(g=function(f,b){return e(f,b,a)},f){case b.onclick:a.onclick=g;break;case b.onmouseover:a.onmouseover=g;break;case b.onchange:a.onchange=g;break;case b.onblur:a.onblur=g;break;default:TypeScript.logging.log(f,TypeScript.ConsoleColors.Yellow)}}};return f}();e.stringEval=f})(d.Handlers||(d.Handlers={}))})(Internal||(Internal={}));
(function(d){(function(e){e.Shared={string:function(){return new e.stringEval},array:function(){return new c},NodeListOf:function(){return new b},HTMLCollection:function(){return new b}};var c=function(){function a(){}a.prototype.doEval=function(a,b,c){return $from(a)};return a}();e.arrayEval=c;var b=function(){function a(){}a.prototype.doEval=function(a,b,c){return new DOMEnumerator(a)};return a}();e.DOMCollection=b})(d.Handlers||(d.Handlers={}))})(Internal||(Internal={}));var DataExtensions;
...
typeof e.ownerDocument}};d.isMessageObject=function(e){var c=$ts.typeof(e);c=Activator.EmptyObject(c.property,!0);return"code"in c&&"info"in c&&Strings.IsPattern(e.code.toString(),/\d+/g)?!0:!1}})(TypeExtensions||(TypeExtensions={}));
...
(function(d){(function(e){(function(c){function b(a,b,c,e,d){a=a.map(function(a){return a.slice()});e=e*(b[d+2]-b[d+1])+b[d+1];for(var f=0;f<c;f++)for(var g=0;g<c-f;g++){var h=d+g+f-(c-2),k=h+c-f;h=b[h]!==b[k]?(e-b[h])/(b[k]-b[h]):0;for(k=0;k<a[0].length;k++)a[g][k]=(1-h)*a[g][k]+h*a[g+1][k]}return a[0]}function a(a,b,c){for(var f=Array(b+1),e=c;e<c+b+1;e++)f[e-c]=a[e].slice();return f}c.interpolation=function(f,c,e){var g=c.length-f.length-1;if(f.length<=g)throw new TypeError("cp.length < d, k === cp + d + 1");
for(var d=Array(e*(f.length-g)+1),h=g-1;h<f.length-1;h++)for(var p=a(f,g,h-g+1),n=0;n<e;n++)d[n+(h-g+1)*e]=b(p,c,g,n/e,h);d[d.length-1]=b(a(f,g,h-g),c,g,1,h-1);return d.map(function(a){return{x:a[0],y:a[1]}})}})(e.BSpline||(e.BSpline={}))})(d.Data||(d.Data={}))})(TypeScript||(TypeScript={}));
...
(function(d){(function(e){e.group=function(c,b){for(var a=[],f=0;f<c.length;f++){for(var e=c[f],d=!1,k=0,l=a;k<l.length;k++){var m=l[k];if(Math.abs(m.Key-e)<=b){d=!0;m.Group.push(e);break}}d||a.push(new Group(e,[e]))}return a}})(d.Data||(d.Data={}))})(TypeScript||(TypeScript={}));
(function(d){(function(e){var c=function(a){function f(){return a.call(this,[])||this}__extends(f,a);Object.defineProperty(f.prototype,"Q",{get:function(){return this.sequence},enumerable:!0,configurable:!0});f.prototype.enqueue=function(a){var f=this.Last,c=this.Q;a=new b(a);c.push(a);f&&(f.below=a,a.above=f)};f.prototype.extract=function(a){var b=this.Q,f=b[a-1],c=b[a+1];a=b.splice(a,1)[0];f&&(f.below=c);c&&(c.above=f);return a};f.prototype.dequeue=function(){return this.extract(0)};return f}(IEnumerator);
...
1==n&&(p=Number(d[3]))}if("hsl"==l||"hwb"==l||"ncol"==l){for(;d.length<m;)d.push("0");("hsl"==l||"hwb"==l)&&360<=parseInt(d[0])&&(d[0]=0);for(g=1;g<m;g++){if(-1<d[g].indexOf("%")){d[g]=d[g].replace("%","");d[g]=Number(d[g]);if(isNaN(d[g]))return e.w3color.emptyObject;d[g]/=100}else d[g]=Number(d[g]);1<Number(d[g])&&(d[g]=1);0>Number(d[g])&&(d[g]=0)}if("hsl"==l){q=e.hslToRgb(d[0],d[1],d[2]);var v=Number(d[0]);var t=Number(d[1])}"hwb"==l&&(q=e.hwbToRgb(d[0],d[1],d[2]));if("ncol"==l)a:{var r=d[0];a=
d[1];q=d[2];var u=r;if(isNaN(parseFloat(r.substr(0,1)))){g=r.substr(0,1).toUpperCase();r=r.substr(1);""==r&&(r=0);r=Number(r);if(isNaN(r)){q=!1;break a}"R"==g&&(u=.6*r);"Y"==g&&(u=60+.6*r);"G"==g&&(u=120+.6*r);"C"==g&&(u=180+.6*r);"B"==g&&(u=240+.6*r);"M"==g&&(u=300+.6*r);"W"==g&&(u=0,a=1-r/100,q=r/100)}q=e.hwbToRgb(u,a,q)}1==n&&(p=Number(d[3]))}if("cmyk"==l){for(;d.length<m;)d.push("0");for(g=0;g<m;g++){if(-1<d[g].indexOf("%")){d[g]=d[g].replace("%","");d[g]=Number(d[g]);if(isNaN(d[g]))return e.w3color.emptyObject;
...
l}return[c+1,k]}}function c(a){switch(!1){case "string"!==typeof a:return""+a.length+":"+a;case "number"!==typeof a:return"i"+(0|a)+"e";case "[object Array]"!=={}.toString.call(a):for(var f=[],d,e=0,k=a.length;e<k;++e)d=a[e],f.push(c(d));return"l"+f.join("")+"e";default:return b(a)}}function b(a){var b=function(b){for(var c in a)({}).hasOwnProperty.call(a,c)&&b.push(c);return b}.call(this,[]).sort();return"d"+function(d){for(var f,e=0,g=b.length;e<g;++e)f=b[e],d.push(""+c(f)+c(a[f]));return d}.call(this,
[]).join("")+"e"}d.decode=function(a){e(a)[1]};d.encode=c})(Bencode||(Bencode={}));var LZW;
...
(Router={}));
var Bootstrap=function(){function d(){this.status="Sleep";this.hookUnload=null}Object.defineProperty(d.prototype,"currentAppPage",{get:function(){return getAllUrlParams().Item("app")||Router.appName||"/"},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"appStatus",{get:function(){return this.status},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"appHookMsg",{get:function(){return this.hookUnload},enumerable:!0,configurable:!0});d.prototype.isCurrentAppPath=function(){var d=
...
(function(d){(function(d){function c(a){void 0===a&&(a="id");var b=document.querySelectorAll("*["+a+"]");a=[];var c=0;for(b=$ts(b).ToArray(!1);c<b.length;c++)a.push(b[c].id);return a}function b(a,b,c){for(var d=function(d){if(-1<b.indexOf(d)){var e=f(a[d]);if(0==e.length||2==e.length)$ts("#"+d).onclick=function(b,c){return a[d](b,c)},TypeScript.logging.log("["+c.class+"] hook onclick for #"+d+"...",TypeScript.ConsoleColors.Green)}},e=0,g=c.methods;e<g.length;e++)d(g[e])}function a(a,b,c){b=$from(b).Select(function(a){return""+
a+"_onchange"}).ToArray();var d=function(c){if(-1==b.indexOf(c))return"continue";var d=f(a[c]),e=c.replace("_onchange",""),g=document.getElementById(e);e=g.tagName.toLowerCase();1==d.length&&"value"==d[0]?"input"==e||"textarea"==e?(d=g.getAttribute("type"),isNullOrUndefined(d)||"file"!=d.toLowerCase()?g.onchange=function(){var b=DOM.InputValueGetter.unifyGetValue(g);return a[c](b)}:g.onchange=function(){var b=$input(g).files;return a[c](b)}):"select"==e?g.onchange=function(){var b=DOM.InputValueGetter.unifyGetValue(g);
return a[c](b)}:TypeScript.logging.log("invalid tag name: "+g.tagName+"!","red"):0==d.length&&($input(g).onchange=function(){return a[c]()})},e=0;for(c=c.methods;e<c.length;e++)d(c[e])}function f(a){a=a.toString().replace(e,"");a=a.slice(a.indexOf("(")+1,a.indexOf(")")).match(h);return null===a?[]:a}d.findAllElement=c;d.hookEventHandles=function(d){var f=c("id"),e=TypeScript.Reflection.$typeof(d);b(d,f,e);a(d,f,e)};var e=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,h=/([^\s,]+)/g;d.parseFunctionArgumentNames=
f})(d.EventHandles||(d.EventHandles={}))})(Internal||(Internal={}));var Framework;
