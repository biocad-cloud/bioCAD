...
function(a){return c.d3cola.on("tick",c.loadGraph(JSON.parse(a)).tick())});TypeScript.logging.log("intialization job done!",TypeScript.ConsoleColors.DarkBlue);return this};d.prototype.loadGraph=function(c){var a=this,g=this.vis.append("g"),f=this.vis.append("g"),h=this.vis.append("g");Strings.Empty(c.class)||"GraphLinksModel"!=c.class||(c=b.translation.translateToColaGraph(c));console.log(JSON.stringify(c));console.log("view nodes details:");console.table(c.nodes);this.d3cola.nodes(c.nodes).links(c.links).groups(c.groups).constraints(c.constraints).start();
this.outer.append("svg:defs").append("svg:marker").attr("id","end-arrow").attr("viewBox","0 -5 10 10").attr("refX",5).attr("markerWidth",3).attr("markerHeight",3).attr("orient","auto").append("svg:path").attr("d","M0,-5L10,0L0,5L2,0").attr("stroke-width","0px").attr("fill","#000");g=g.selectAll(".group").data(c.groups).enter().append("rect").attr("rx",8).attr("ry",8).attr("class","group").attr("style",function(a){return a.style});h=h.selectAll(".link").data(c.links).enter().append("line").attr("class",
"link");var e=f.selectAll(".node").data(c.nodes).enter().append("rect").attr("class","node").attr("width",function(c){return c.width+2*a.pad+2*a.margin}).attr("height",function(c){return c.height+2*a.pad+2*a.margin}).attr("rx",function(a){return a.rx}).attr("ry",function(a){return a.rx}).call(this.d3cola.drag);c=f.selectAll(".label").data(c.nodes).enter().append("text").attr("class","label").call(this.d3cola.drag);c.each(d.insertLinebreaks);e.append("title").text(function(a){return a.label});return new b.Cola_graph(e,
h,g,c,this)};d.insertLinebreaks=function(c){var a=d3.select(this);c=c.label.split(" ");a.text("");for(var b=0;b<c.length;b++){var f=c[b];f=a.append("tspan").text(f);f.attr("x",0).attr("dy","15").attr("font-size","12")}};return d}();b.Metabolic_pathway=d})(apps||(apps={}));
(function(b){(function(b){b.paper_colors="#D02823 #0491d0 #88bb64 #15DBFF #583B73 #f2ce3f #8858BF #CCFF33 #fb5b44 #361f32 #DF2789 #396b1c".split(" ");b.translateToColaGraph=function(d){for(var c={groups:[],constraints:[],links:[],nodes:[]},a={},g={},f=0,h=d.nodeDataArray;f<h.length;f++){var e=h[f];if(!isNullOrUndefined(e.isGroup)&&e.isGroup){var k=b.paper_colors[Object.keys(g).length];g[e.key.toString()]={leaves:[],padding:10,style:"fill:"+k+";fill-opacity:0.31764700000000001;stroke:"+k+";stroke-opacity:1"}}}f=
0;for(h=d.nodeDataArray;f<h.length;f++)if(e=h[f],isNullOrUndefined(e.isGroup)||!e.isGroup)c.nodes.push({dunnartid:(c.nodes.length+1).toString(),height:40,index:c.nodes.length,label:e.label,rx:9,ry:9,width:60,x:0,y:0}),a[e.key]=c.nodes.length-1,isNullOrUndefined(e.group)||g[e.group.toString()].leaves.push(c.nodes.length-1);e=0;for(d=d.linkDataArray;e<d.length;e++)f=d[e],c.links.push({source:a[f.from],target:a[f.to]});for(var m in g)c.groups.push(g[m]);return c}})(b.translation||(b.translation={}))})(apps||
(apps={}));
(function(b){var d=function(d){function c(){var a=null!==d&&d.apply(this,arguments)||this;a.SD={mode:"pointer",itemType:"pointer",nodeCounter:{stock:0,cloud:0,variable:0,valve:0}};return a}__extends(c,d);Object.defineProperty(c.prototype,"appName",{get:function(){return"FlowEditor"},enumerable:!0,configurable:!0});c.prototype.config=function(){var a=this.SD,c=this;return{"undoManager.isEnabled":!0,allowLink:!1,"animationManager.isEnabled":!1,"linkingTool.portGravity":0,"linkingTool.doActivate":function(){this.temporaryLink.curve="flow"===
a.itemType?go.Link.Normal:go.Link.Bezier;this.temporaryLink.path.stroke="flow"===a.itemType?"blue":"green";this.temporaryLink.path.strokeWidth="flow"===a.itemType?5:1;go.LinkingTool.prototype.doActivate.call(this)},"linkingTool.insertLink":function(b,d,g,e){c.myDiagram.model.setCategoryForLinkData(this.archetypeLinkData,a.itemType);this.archetypeLabelNodeData="flow"===a.itemType?{category:"valve"}:null;this.archetypeLinkData.text=a.itemType;return go.LinkingTool.prototype.insertLink.call(this,b,d,
g,e)},"clickCreatingTool.archetypeNodeData":{},"commandHandler.archetypeGroupData":{text:"Group",isGroup:!0,color:"blue"},"clickCreatingTool.isDoubleClick":!1,"clickCreatingTool.canStart":function(){return"node"===a.mode&&go.ClickCreatingTool.prototype.canStart.call(this)},"clickCreatingTool.insertPart":function(c){a.nodeCounter[a.itemType]+=1;var b=a.itemType+a.nodeCounter[a.itemType];this.archetypeNodeData={key:b,category:a.itemType,label:b};return go.ClickCreatingTool.prototype.insertPart.call(this,
c)}}};c.prototype.init=function(){var a=go.GraphObject.make,c=this.SD,b=this.myDiagram=a(go.Diagram,"myDiagram",this.config());b.toolManager.mouseMoveTools.insertAt(0,new NodeLabelDraggingTool);b.addDiagramListener("Modified",function(a){a=document.getElementById("SaveButton");var c=document.title.indexOf("*");a&&(a.disabled=!b.isModified);b.isModified?0>c&&(document.title+="*"):0<=c&&(document.title=document.title.substr(0,c))});b.addDiagramListener("LinkDrawn",function(a){var d=a.subject;"flow"===
d.category&&(b.startTransaction("updateNode"),c.nodeCounter.valve+=1,a="flow"+c.nodeCounter.valve,d=d.labelNodes.first(),b.model.setDataProperty(d.data,"label",a),b.commitTransaction("updateNode"))});this.buildTemplates();this.load()};c.prototype.buildTemplates=function(){var a=go.GraphObject.make,d=this.myDiagram;d.nodeTemplateMap.add("stock",a(go.Node,b.EditorTemplates.nodeStyle(),a(go.Shape,b.EditorTemplates.shapeStyle(),{desiredSize:new go.Size(50,30)}),a(go.TextBlock,b.EditorTemplates.textStyle(),
{_isNodeLabel:!0,alignment:new go.Spot(.5,.5,0,30)},(new go.Binding("alignment","label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));d.nodeTemplateMap.add("cloud",a(go.Node,b.EditorTemplates.nodeStyle(),a(go.Shape,b.EditorTemplates.shapeStyle(),{figure:"Cloud",desiredSize:new go.Size(35,35)})));d.nodeTemplateMap.add("valve",a(go.Node,b.EditorTemplates.nodeStyle(),{movable:!1,layerName:"Foreground",alignmentFocus:go.Spot.None},a(go.Shape,b.EditorTemplates.shapeStyle(),{figure:"Ellipse",
desiredSize:new go.Size(20,20)}),a(go.TextBlock,b.EditorTemplates.textStyle(),{_isNodeLabel:!0,alignment:new go.Spot(.5,.5,0,20)},(new go.Binding("alignment","label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));d.nodeTemplateMap.add("variable",a(go.Node,b.EditorTemplates.nodeStyle(),{type:go.Panel.Auto},a(go.TextBlock,b.EditorTemplates.textStyle(),{isMultiline:!1}),a(go.Shape,b.EditorTemplates.shapeStyle(),{isPanelMain:!0,stroke:null,fill:"transparent"})));d.linkTemplateMap.add("flow",
a(go.Link,{toShortLength:8},a(go.Shape,{stroke:"blue",strokeWidth:5}),a(go.Shape,{fill:"blue",stroke:null,toArrow:"Standard",scale:2.5})));d.linkTemplateMap.add("influence",a(go.Link,{curve:go.Link.Bezier,toShortLength:8},a(go.Shape,{stroke:"green",strokeWidth:1.5}),a(go.Shape,{fill:"green",stroke:null,toArrow:"Standard",scale:1.5})));d.groupTemplate=a(go.Group,"Vertical",{selectionObjectName:"PANEL",ungroupable:!0},a(go.TextBlock,{font:"bold 19px sans-serif",isMultiline:!1,editable:!0},(new go.Binding("text",
"text")).makeTwoWay(),new go.Binding("stroke","color")),a(go.Panel,"Auto",{name:"PANEL"},a(go.Shape,"Rectangle",{fill:"rgba(128,128,128,0.2)",stroke:"gray",strokeWidth:3,portId:"",cursor:"pointer",fromLinkable:!0,fromLinkableSelfNode:!0,fromLinkableDuplicates:!0,toLinkable:!0,toLinkableSelfNode:!0,toLinkableDuplicates:!0}),a(go.Placeholder,{margin:10,background:"transparent"})),{toolTip:a("ToolTip",a(go.TextBlock,{margin:4},(new go.Binding("text","",c.groupInfo)).ofObject()))})};c.groupInfo=function(a){a=
a.adornedPart;var c=a.memberParts.count,b=0;a.memberParts.each(function(a){a instanceof go.Link&&b++});return"Group "+a.data.key+": "+a.data.text+"\n"+c+" members including "+b+" links"};c.prototype.setMode=function(a,c){var b=this.myDiagram,d=this.SD;b.startTransaction();document.getElementById(d.itemType).className=d.mode+"_normal";document.getElementById(c).className=a+"_selected";d.mode=a;d.itemType=c;"pointer"===a?(b.allowLink=!1,b.nodes.each(function(a){return a.port.cursor=""})):"node"===a?
(b.allowLink=!1,b.nodes.each(function(a){return a.port.cursor=""})):"link"===a&&(b.allowLink=!0,b.nodes.each(function(a){return a.port.cursor="pointer"}));b.commitTransaction("mode changed")};c.prototype.save_click=function(){this.dosave()};c.prototype.load=function(){var a=this;$ts.getText("@api:load?model_id="+$ts("@data:model_id"),function(c){c=b.ModelPatch(JSON.parse(c));c=JSON.stringify(c);a.myDiagram.model=go.Model.fromJson(c)})};c.prototype.dosave=function(a){void 0===a&&(a=null);var c=this.myDiagram,
d=c.model.toJson();d={guid:$ts("@data:model_id"),model:b.ModelPatch(JSON.parse(d)),type:"dynamics"};c.isModified=!1;$ts.post("@api:save",d,function(c){0!=c.code?console.error(c.info):isNullOrUndefined(c.info)||isNullOrUndefined(a)||a(c.info)})};c.prototype.pointer_click=function(){this.setMode("pointer","pointer")};c.prototype.stock_click=function(){this.setMode("node","stock")};c.prototype.cloud_click=function(){this.setMode("node","cloud")};c.prototype.variable_click=function(){this.setMode("node",
...
f.to=d(f.to),!isNullOrEmpty(f.labelKeys))for(var h=0;h<f.labelKeys.length;h++)Strings.IsPattern(f.labelKeys[h].toString(),e)&&(f.labelKeys[h]="T"+f.labelKeys[h]),f.labelKeys[h]=d(f.labelKeys[h]);return c}})(apps||(apps={}));
(function(b){(function(b){b.nodeStyle=function(){return[{type:go.Panel.Spot,layerName:"Background",locationObjectName:"SHAPE",selectionObjectName:"SHAPE",locationSpot:go.Spot.Center},(new go.Binding("location","loc",go.Point.parse)).makeTwoWay(go.Point.stringify)]};b.shapeStyle=function(){return{name:"SHAPE",stroke:"black",fill:"#f0f0f0",portId:"",fromLinkable:!0,toLinkable:!0}};b.textStyle=function(){return[{font:"bold 11pt helvetica, bold arial, sans-serif",margin:2,editable:!0},(new go.Binding("text",
"label")).makeTwoWay()]}})(b.EditorTemplates||(b.EditorTemplates={}))})(apps||(apps={}));
...
target:this.nodeLookup[f].index}):console.warn("missing node of "+f):console.warn("missing node of "+e)}a=0;for(d=this.sbsvg.selectAll(".cluster")[0];a<d.length;a++)e=d[a],this.graph.groups.push({leaves:e.getAttribute("dunnart:contains").split(" ").map(function(a){return b.nodeLookup[a].index}),style:e.getAttribute("style"),padding:10});a={};d=0;for(e=this.sbsvg.selectAll("[relType=alignment]")[0];d<e.length;d++){var l=e[d];f=l.getAttribute("constraintid");var k=this.nodeLookup[l.getAttribute("objoneid")].index;
l=parseInt(l.getAttribute("alignmentpos"));k={node:k,offset:0};f in a?a[f].offsets.push(k):this.graph.constraints.push(a[f]={type:"alignment",offsets:[k],axis:1==l?"y":"x"})}return this.graph};b.prototype.loadNodes=function(b){var a=0,c=0;for(b=b.selectAll("rect.shape")[0];c<b.length;c++){var d=b[c];this.graph.nodes.push(this.nodeLookup[d.id]={label:d.getAttribute("dunnart:label"),dunnartid:d.id,index:a++,width:60,height:40,x:parseFloat(d.getAttribute("x")),y:parseFloat(d.getAttribute("y")),rx:"rx"in
