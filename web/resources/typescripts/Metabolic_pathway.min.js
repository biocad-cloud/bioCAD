var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(b,d,f){b!=Array.prototype&&b!=Object.prototype&&(b[d]=f.value)};$jscomp.getGlobal=function(b){return"undefined"!=typeof window&&window===b?b:"undefined"!=typeof global&&null!=global?global:b};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(b,d,f,c){if(d){f=$jscomp.global;b=b.split(".");for(c=0;c<b.length-1;c++){var a=b[c];a in f||(f[a]={});f=f[a]}b=b[b.length-1];c=f[b];d=d(c);d!=c&&null!=d&&$jscomp.defineProperty(f,b,{configurable:!0,writable:!0,value:d})}};$jscomp.underscoreProtoCanBeSet=function(){var b={a:!0},d={};try{return d.__proto__=b,d.a}catch(f){}return!1};
...
$jscomp.iteratorFromArray=function(b,d){$jscomp.initSymbolIterator();b instanceof String&&(b+="");var f=0,c={next:function(){if(f<b.length){var a=f++;return{value:d(a,b[a]),done:!1}}c.next=function(){return{done:!0,value:void 0}};return c.next()}};c[Symbol.iterator]=function(){return c};return c};$jscomp.polyfill("Array.prototype.keys",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(b){return b})}},"es6","es3");
var __extends=this&&this.__extends||function(){var b=function(d,f){b=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(c,a){c.__proto__=a}||function(c,a){for(var g in a)a.hasOwnProperty(g)&&(c[g]=a[g])};return b(d,f)};return function(d,f){function c(){this.constructor=d}b(d,f);d.prototype=null===f?Object.create(f):(c.prototype=f.prototype,new c)}}(),biodeep;
(function(b){(function(b){b.start=function(){Router.AddAppHandler(new apps.PathwayExplorer);Router.AddAppHandler(new apps.FlowEditor);Router.AddAppHandler(new apps.KEGGNetwork);Router.AddAppHandler(new apps.Viewer);Router.RunApp()}})(b.app||(b.app={}))})(biodeep||(biodeep={}));var __indexOf=Array.prototype.indexOf||function(b){for(var d=0,f=this.length;d<f;d++)if(d in this&&this[d]===b)return d;return-1};$ts.mode=Modes.debug;$ts(biodeep.app.start);var apps;
(function(b){var d=function(){function b(c,a,g,e,b){this.node=c;this.link=a;this.group=g;this.label=e;this.vm=b;console.log(this)}b.prototype.tick=function(){var c=this.vm,a=this;return function(){a.node.each(function(a){return a.innerBounds=a.bounds.inflate(-c.margin)});a.link.each(function(a){return a.route=cola.makeEdgeBetween(a.source.innerBounds,a.target.innerBounds,5)});a.link.attr("x1",function(a){return a.route.sourceIntersection.x}).attr("y1",function(a){return a.route.sourceIntersection.y}).attr("x2",
function(a){return a.route.arrowStart.x}).attr("y2",function(a){return a.route.arrowStart.y});a.label.each(function(a){var e=this.getBBox();a.width=e.width+2*c.margin+8;a.height=e.height+2*c.margin+8});a.node.attr("x",function(a){return a.innerBounds.x}).attr("y",function(a){return a.innerBounds.y}).attr("width",function(a){return a.innerBounds.width()}).attr("height",function(a){return a.innerBounds.height()});a.group.attr("x",function(a){return a.bounds.x}).attr("y",function(a){return a.bounds.y}).attr("width",
...
function(c){var a=this,g=this.vis.append("g"),e=this.vis.append("g"),k=this.vis.append("g");Strings.Empty(c.class)||"GraphLinksModel"!=c.class||(c=b.translation.translateToColaGraph(c));console.log(JSON.stringify(c));console.log("view nodes details:");console.table(c.nodes);this.d3cola.nodes(c.nodes).links(c.links).groups(c.groups).constraints(c.constraints).start();this.outer.append("svg:defs").append("svg:marker").attr("id","end-arrow").attr("viewBox","0 -5 10 10").attr("refX",5).attr("markerWidth",
3).attr("markerHeight",3).attr("orient","auto").append("svg:path").attr("d","M0,-5L10,0L0,5L2,0").attr("stroke-width","0px").attr("fill","#000");g=g.selectAll(".group").data(c.groups).enter().append("rect").attr("rx",8).attr("ry",8).attr("class","group").attr("style",function(a){return a.style});k=k.selectAll(".link").data(c.links).enter().append("line").attr("class","link");var f=e.selectAll(".node").data(c.nodes).enter().append("rect").attr("class","node").attr("width",function(c){return c.width+
2*a.pad+2*a.margin}).attr("height",function(c){return c.height+2*a.pad+2*a.margin}).attr("rx",function(a){return a.rx}).attr("ry",function(a){return a.rx}).call(this.d3cola.drag);c=e.selectAll(".label").data(c.nodes).enter().append("text").attr("class","label").call(this.d3cola.drag);c.each(d.insertLinebreaks);f.append("title").text(function(a){return a.label});return new b.Cola_graph(f,k,g,c,this)};d.insertLinebreaks=function(c){var a=d3.select(this);c=c.label.split(" ");a.text("");for(var b=0;b<
c.length;b++){var e=c[b];e=a.append("tspan").text(e);e.attr("x",0).attr("dy","15").attr("font-size","12")}};return d}();b.Metabolic_pathway=d})(apps||(apps={}));
(function(b){(function(b){b.paper_colors="#D02823 #0491d0 #88bb64 #15DBFF #583B73 #f2ce3f #8858BF #CCFF33 #fb5b44 #361f32 #DF2789 #396b1c".split(" ");b.translateToColaGraph=function(d){for(var c={groups:[],constraints:[],links:[],nodes:[]},a={},g={},e=0,k=d.nodeDataArray;e<k.length;e++){var f=k[e];if(!isNullOrUndefined(f.isGroup)&&f.isGroup){var h=b.paper_colors[Object.keys(g).length];g[f.key.toString()]={leaves:[],padding:10,style:"fill:"+h+";fill-opacity:0.31764700000000001;stroke:"+h+";stroke-opacity:1"}}}e=
0;for(k=d.nodeDataArray;e<k.length;e++)f=k[e],!isNullOrUndefined(f.isGroup)&&f.isGroup||"valve"==f.category||(h=f.loc,h=Strings.Empty(h)?[0,0]:h.split(/\s+/ig).map(function(a){return parseFloat(a)}),2>h.length&&(h=[0,0]),c.nodes.push({dunnartid:(c.nodes.length+1).toString(),height:40,index:c.nodes.length,label:f.label,rx:9,ry:9,width:60,x:h[0],y:h[1]}),a[f.key]=c.nodes.length-1,isNullOrUndefined(f.group)||g[f.group.toString()].leaves.push(c.nodes.length-1));f=0;for(d=d.linkDataArray;f<d.length;f++)e=
d[f],c.links.push({source:a[e.from],target:a[e.to]});for(var m in g)c.groups.push(g[m]);return c}})(b.translation||(b.translation={}))})(apps||(apps={}));
...
"flow"===a.itemType?go.Link.Normal:go.Link.Bezier;this.temporaryLink.path.stroke="flow"===a.itemType?"blue":"green";this.temporaryLink.path.strokeWidth="flow"===a.itemType?5:1;go.LinkingTool.prototype.doActivate.call(this)},"linkingTool.insertLink":function(e,b,g,d){c.goCanvas.model.setCategoryForLinkData(this.archetypeLinkData,a.itemType);this.archetypeLabelNodeData="flow"===a.itemType?{category:"valve"}:null;this.archetypeLinkData.text=a.itemType;return go.LinkingTool.prototype.insertLink.call(this,
e,b,g,d)},"clickCreatingTool.archetypeNodeData":{},"commandHandler.archetypeGroupData":{text:"Group",isGroup:!0,color:"blue"},"clickCreatingTool.isDoubleClick":!1,"clickCreatingTool.canStart":function(){return"node"===a.mode&&go.ClickCreatingTool.prototype.canStart.call(this)},"clickCreatingTool.insertPart":function(c){a.nodeCounter[a.itemType]+=1;var e=a.itemType+a.nodeCounter[a.itemType];this.archetypeNodeData={key:e,category:a.itemType,label:e};return go.ClickCreatingTool.prototype.insertPart.call(this,
c)}}};c.prototype.init=function(){var a=go.GraphObject.make,c=this.SD,e=this.goCanvas=a(go.Diagram,"myDiagram",this.config());e.toolManager.mouseMoveTools.insertAt(0,new NodeLabelDraggingTool);e.addDiagramListener("Modified",function(a){a=document.getElementById("SaveButton");var c=document.title.indexOf("*");a&&(a.disabled=!e.isModified);e.isModified?0>c&&(document.title+="*"):0<=c&&(document.title=document.title.substr(0,c))});e.addDiagramListener("LinkDrawn",function(a){var b=a.subject;"flow"===
b.category&&(e.startTransaction("updateNode"),c.nodeCounter.valve+=1,a="flow"+c.nodeCounter.valve,b=b.labelNodes.first(),e.model.setDataProperty(b.data,"label",a),e.commitTransaction("updateNode"))});this.buildTemplates();this.load()};c.prototype.buildTemplates=function(){var a=go.GraphObject.make,g=this.goCanvas;g.nodeTemplateMap.add("stock",a(go.Node,b.EditorTemplates.nodeStyle(),a(go.Shape,b.EditorTemplates.shapeStyle(),{desiredSize:new go.Size(90,30)}),a(go.TextBlock,b.EditorTemplates.textStyle(10),
new go.Binding("text","label"))));g.nodeTemplateMap.add("cloud",a(go.Node,b.EditorTemplates.nodeStyle(),a(go.Shape,b.EditorTemplates.shapeStyle(),{figure:"Cloud",desiredSize:new go.Size(35,35)})));g.nodeTemplateMap.add("valve",a(go.Node,b.EditorTemplates.nodeStyle(),{movable:!1,layerName:"Foreground",alignmentFocus:go.Spot.None},a(go.Shape,b.EditorTemplates.shapeStyle(),{figure:"Ellipse",desiredSize:new go.Size(5,5)}),a(go.TextBlock,b.EditorTemplates.textStyle(0),{_isNodeLabel:!0,alignment:new go.Spot(.5,
.5,0,20)},(new go.Binding("alignment","label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));g.nodeTemplateMap.add("variable",a(go.Node,b.EditorTemplates.nodeStyle(),{type:go.Panel.Auto},a(go.TextBlock,b.EditorTemplates.textStyle(),{isMultiline:!1}),a(go.Shape,b.EditorTemplates.shapeStyle(),{isPanelMain:!0,stroke:null,fill:"transparent"})));g.linkTemplateMap.add("flow",a(go.Link,{toShortLength:8,routing:go.Link.AvoidsNodes,corner:5,relinkableFrom:!0,relinkableTo:!0,reshapable:!0,resegmentable:!0},
a(go.Shape,{stroke:"blue",strokeWidth:3}),a(go.Shape,{fill:"blue",stroke:null,toArrow:"Standard",scale:1.5})));g.linkTemplateMap.add("influence",a(go.Link,{curve:go.Link.Bezier,toShortLength:8},a(go.Shape,{stroke:"green",strokeWidth:1.5}),a(go.Shape,{fill:"green",stroke:null,toArrow:"Standard",scale:1.5})));g.groupTemplate=a(go.Group,"Vertical",{selectionObjectName:"PANEL",ungroupable:!0},a(go.TextBlock,{font:"bold 19px sans-serif",isMultiline:!1,editable:!0},(new go.Binding("text","text")).makeTwoWay(),
...
var c=a.memberParts.count,e=0;a.memberParts.each(function(a){a instanceof go.Link&&e++});return"Group "+a.data.key+": "+a.data.text+"\n"+c+" members including "+e+" links"};c.prototype.setMode=function(a,c){var e=this.goCanvas,b=this.SD;e.startTransaction();document.getElementById(b.itemType).className=b.mode+"_normal";document.getElementById(c).className=a+"_selected";b.mode=a;b.itemType=c;"pointer"===a?(e.allowLink=!1,e.nodes.each(function(a){return a.port.cursor=""})):"node"===a?(e.allowLink=!1,
e.nodes.each(function(a){return a.port.cursor=""})):"link"===a&&(e.allowLink=!0,e.nodes.each(function(a){return a.port.cursor="pointer"}));e.commitTransaction("mode changed")};c.prototype.autoLayout_click=function(){(new Editor.layouts.circle(this)).generateCircle()};c.prototype.save_click=function(){this.dosave()};c.prototype.load=function(){var a=this,c=$ts("@data:model_id"),b="@api:load?model_id="+c;Strings.Empty(c,!0)||"#"!=c.charAt(0)?$ts.getText(b,function(c){return a.loadModelFromJsonText(c)}):
this.loadModelFromJsonText($ts.text(c))};c.prototype.loadModelFromJsonText=function(a){a=b.ModelPatch(JSON.parse(a));a=JSON.stringify(a);this.goCanvas.model=go.Model.fromJson(a)};c.prototype.dosave=function(a){void 0===a&&(a=null);var c=this.goCanvas,e=c.model.toJson();e={guid:$ts("@data:model_id"),model:b.ModelPatch(JSON.parse(e)),type:"dynamics"};c.isModified=!1;$ts.post("@api:save",e,function(c){0!=c.code?console.error(c.info):isNullOrUndefined(c.info)||isNullOrUndefined(a)||a(c.info)})};c.prototype.pointer_click=
...
(function(b){function d(c){return c?c.toString().replace(".","_").replace("-","_").replace("+","_").replace("*","_").replace("~","_"):null}var f=/[-]?\d+/ig;b.ModelPatch=function(c){for(var a=0,b=c.nodeDataArray;a<b.length;a++){var e=b[a];e.isGroup||(Strings.IsPattern(e.key.toString(),f)&&(e.key="T"+e.key),isNullOrUndefined(e.group)&&delete e.group,e.key=d(e.key))}a=0;for(b=c.linkDataArray;a<b.length;a++)if(e=b[a],Strings.IsPattern(e.from.toString(),f)&&(e.from="T"+e.from),Strings.IsPattern(e.to.toString(),
f)&&(e.to="T"+e.to),e.from=d(e.from),e.to=d(e.to),!isNullOrEmpty(e.labelKeys))for(var k=0;k<e.labelKeys.length;k++)Strings.IsPattern(e.labelKeys[k].toString(),f)&&(e.labelKeys[k]="T"+e.labelKeys[k]),e.labelKeys[k]=d(e.labelKeys[k]);return c}})(apps||(apps={}));
...
var f=1;b.parseJsTree=d})(PathwayNavigator||(PathwayNavigator={}));
(function(b){b.listDiv="#sample_suggests";b.inputDiv="#sample_search";var d=function(d){function c(){return null!==d&&d.apply(this,arguments)||this}__extends(c,d);Object.defineProperty(c.prototype,"appName",{get:function(){return"kegg_network"},enumerable:!0,configurable:!0});c.prototype.init=function(){var a=this;b.PathwayExplorer.initKEGG(function(){return a.loadCache()})};c.prototype.loadCache=function(){var a=this,d=PathwayNavigator.parseJsTree(b.PathwayExplorer.loadKEGGTree()),e=[];c.createSet(d,
e);d=[];for(var f=0,l=$from(e).GroupBy(function(a){return a.text.split(/\s+/ig)[0]}).Select(function(a){return a.First}).ToArray();f<l.length;f++){var h=l[f];d.push(new Application.Suggestion.term(h.id,h.text))}var m=Application.Suggestion.render.makeSuggestions(d,b.listDiv,function(c){return a.clickOnTerm(c)},13,!0,"");$ts(b.inputDiv).onkeyup=function(){var a=$ts.value(b.inputDiv);Strings.Empty(a,!0)?$ts(b.listDiv).hide():($ts(b.listDiv).show(),m(a))};TypeScript.logging.log(e.length+" kegg components has been loaded!",
...
var Graph=function(){function b(b){void 0===b&&(b=null);this.last_index=0;isNullOrUndefined(b)||(this.nodes=b.nodes,this.links=b.links)}b.prototype.objectify=function(){for(var b=this,f=b.links,c=[],a=function(a,d){var e=f[a];c.push(function(){var a;var c=b.nodes;var d=[];var f=0;for(a=c.length;f<a;f++){var g=c[f];e.source===g.id?e.source=g:e.target===g.id?e.target=g:d.push(void 0)}return d}())},g=0,e=f.length;g<e;g++)a(g,e);return c};b.prototype.remove=function(b){if(0<=__indexOf.call(this.nodes,
b))return this.nodes=this.nodes.filter(function(d){return d!==b}),this.links=this.links.filter(function(d){return d.source.id!==b.id&&d.target.id!==b.id});if(0<=__indexOf.call(this.links,b))return this.links=this.links.filter(function(d){return d!==b})};b.prototype.add_node=function(b){b={dunnartid:(this.last_index++).toString(),x:0,y:0,type:b};this.nodes.push(b);return b};b.prototype.add_link=function(b,f){if(b===f)return null;for(var c=this.links,a=0,d=c.length;a<d;a++){var e=c[a];if(e.source===
b&&e.target===f)return null}b={source:b,target:f};this.links.push(b);return b};return b}(),dataAdapter;
(function(b){var d=function(){function b(b){void 0===b&&(b="#embeddedsvg");this.nodeLookup={};this.sbsvg=d3.select($ts(b)).select("svg");this.graph={nodes:[],links:[],constraints:[],groups:[]}}b.prototype.getGraph=function(){var b=this;this.loadNodes(this.sbsvg);for(var a=0,d=this.sbsvg.selectAll(".connector")[0];a<d.length;a++){var e=d[a],f=e.getAttribute("dunnart:srcid");e=e.getAttribute("dunnart:dstid");f in this.nodeLookup?e in this.nodeLookup?this.graph.links.push({source:this.nodeLookup[f].index,
target:this.nodeLookup[e].index}):console.warn("missing node of "+e):console.warn("missing node of "+f)}a=0;for(d=this.sbsvg.selectAll(".cluster")[0];a<d.length;a++)f=d[a],this.graph.groups.push({leaves:f.getAttribute("dunnart:contains").split(" ").map(function(a){return b.nodeLookup[a].index}),style:f.getAttribute("style"),padding:10});a={};d=0;for(f=this.sbsvg.selectAll("[relType=alignment]")[0];d<f.length;d++){var l=f[d];e=l.getAttribute("constraintid");var h=this.nodeLookup[l.getAttribute("objoneid")].index;
l=parseInt(l.getAttribute("alignmentpos"));h={node:h,offset:0};e in a?a[e].offsets.push(h):this.graph.constraints.push(a[e]={type:"alignment",offsets:[h],axis:1==l?"y":"x"})}return this.graph};b.prototype.loadNodes=function(b){var a=0,c=0;for(b=b.selectAll("rect.shape")[0];c<b.length;c++){var d=b[c];this.graph.nodes.push(this.nodeLookup[d.id]={label:d.getAttribute("dunnart:label"),dunnartid:d.id,index:a++,width:60,height:40,x:parseFloat(d.getAttribute("x")),y:parseFloat(d.getAttribute("y")),rx:"rx"in
