...
(function(d){(function(b){b.translateToColaGraph=function(b){for(var c={groups:[],constraints:[],links:[],nodes:[]},a={},g=0,e=b.nodeDataArray;g<e.length;g++){var d=e[g];c.nodes.push({dunnartid:(c.nodes.length+1).toString(),height:40,index:c.nodes.length,label:d.label,rx:9,ry:9,width:60,x:0,y:0});a[d.key]=c.nodes.length-1}g=0;for(b=b.linkDataArray;g<b.length;g++)e=b[g],c.links.push({source:a[e.from],target:a[e.to]});return c}})(d.translation||(d.translation={}))})(apps||(apps={}));
...
"flow"===a.itemType?go.Link.Normal:go.Link.Bezier;this.temporaryLink.path.stroke="flow"===a.itemType?"blue":"green";this.temporaryLink.path.strokeWidth="flow"===a.itemType?5:1;go.LinkingTool.prototype.doActivate.call(this)},"linkingTool.insertLink":function(e,b,g,d){c.myDiagram.model.setCategoryForLinkData(this.archetypeLinkData,a.itemType);this.archetypeLabelNodeData="flow"===a.itemType?{category:"valve"}:null;this.archetypeLinkData.text=a.itemType;return go.LinkingTool.prototype.insertLink.call(this,
