...
model:JSON.parse(c),type:"dynamics"};b.isModified=!1;$ts.post("@api:save",c,function(b){0!=b.code?console.error(b.info):isNullOrUndefined(b.info)||a(b.info)})};c.prototype.pointer_click=function(){this.setMode("pointer","pointer")};c.prototype.stock_click=function(){this.setMode("node","stock")};c.prototype.cloud_click=function(){this.setMode("node","cloud")};c.prototype.variable_click=function(){this.setMode("node","variable")};c.prototype.flow_click=function(){this.setMode("link","flow")};c.prototype.influence_click=
function(){this.setMode("link","influence")};c.prototype.run_click=function(){var a=this;this.dosave(function(b){return a.doRunModel(b)})};c.prototype.doRunModel=function(a){$ts.post("@api:run/"+a,{guid:a},function(a){0!=a.code?console.error(a.info):$goto(a.url)})};return c}(Bootstrap);d.FlowEditor=b})(apps||(apps={}));
