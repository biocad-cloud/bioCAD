...
"label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));b.nodeTemplateMap.add("cloud",a(go.Node,d.EditorTemplates.nodeStyle(),a(go.Shape,d.EditorTemplates.shapeStyle(),{figure:"Cloud",desiredSize:new go.Size(35,35)})));b.nodeTemplateMap.add("valve",a(go.Node,d.EditorTemplates.nodeStyle(),{movable:!1,layerName:"Foreground",alignmentFocus:go.Spot.None},a(go.Shape,d.EditorTemplates.shapeStyle(),{figure:"Ellipse",desiredSize:new go.Size(20,20)}),a(go.TextBlock,d.EditorTemplates.textStyle(),{_isNodeLabel:!0,
alignment:new go.Spot(.5,.5,0,20)},(new go.Binding("alignment","label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));b.nodeTemplateMap.add("variable",a(go.Node,d.EditorTemplates.nodeStyle(),{type:go.Panel.Auto},a(go.TextBlock,d.EditorTemplates.textStyle(),{isMultiline:!1}),a(go.Shape,d.EditorTemplates.shapeStyle(),{isPanelMain:!0,stroke:null,fill:"transparent"})));b.linkTemplateMap.add("flow",a(go.Link,{toShortLength:8},a(go.Shape,{stroke:"blue",strokeWidth:5}),a(go.Shape,{fill:"blue",stroke:null,
toArrow:"Standard",scale:2.5})));b.linkTemplateMap.add("influence",a(go.Link,{curve:go.Link.Bezier,toShortLength:8},a(go.Shape,{stroke:"green",strokeWidth:1.5}),a(go.Shape,{fill:"green",stroke:null,toArrow:"Standard",scale:1.5})))};c.prototype.setMode=function(a,b){var c=this.myDiagram,d=this.SD;c.startTransaction();document.getElementById(d.itemType+"_button").className=d.mode+"_normal";document.getElementById(b+"_button").className=a+"_selected";d.mode=a;d.itemType=b;"pointer"===a?(c.allowLink=
!1,c.nodes.each(function(a){a.port.cursor=""})):"node"===a?(c.allowLink=!1,c.nodes.each(function(a){a.port.cursor=""})):"link"===a&&(c.allowLink=!0,c.nodes.each(function(a){a.port.cursor="pointer"}));c.commitTransaction("mode changed")};c.prototype.save=function(){var a=this.myDiagram;a.model.toJson();a.isModified=!1};c.prototype.load=function(){this.myDiagram.model=go.Model.fromJson($ts.text("#demo-system"))};c.prototype.pointer_click=function(){this.setMode("pointer","pointer")};c.prototype.stock_click=
function(){this.setMode("node","stock")};c.prototype.cloud_click=function(){this.setMode("node","cloud")};c.prototype.variable_click=function(){this.setMode("node","variable")};c.prototype.flow_click=function(){this.setMode("link","flow")};c.prototype.influence_click=function(){this.setMode("link","influence")};return c}(Bootstrap);d.FlowEditor=b})(apps||(apps={}));
...
c.attributes?parseFloat(c.getAttribute("rx")):5,ry:"ry"in c.attributes?parseFloat(c.getAttribute("ry")):5})}};return b}();d.parseDunnart=b})(dataAdapter||(dataAdapter={}));
