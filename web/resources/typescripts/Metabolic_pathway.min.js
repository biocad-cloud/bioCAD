var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(d,b,e){d!=Array.prototype&&d!=Object.prototype&&(d[b]=e.value)};$jscomp.getGlobal=function(d){return"undefined"!=typeof window&&window===d?d:"undefined"!=typeof global&&null!=global?global:d};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(d,b,e,c){if(b){e=$jscomp.global;d=d.split(".");for(c=0;c<d.length-1;c++){var a=d[c];a in e||(e[a]={});e=e[a]}d=d[d.length-1];c=e[d];b=b(c);b!=c&&null!=b&&$jscomp.defineProperty(e,d,{configurable:!0,writable:!0,value:b})}};$jscomp.underscoreProtoCanBeSet=function(){var d={a:!0},b={};try{return b.__proto__=d,b.a}catch(e){}return!1};
$jscomp.setPrototypeOf="function"==typeof Object.setPrototypeOf?Object.setPrototypeOf:$jscomp.underscoreProtoCanBeSet()?function(d,b){d.__proto__=b;if(d.__proto__!==b)throw new TypeError(d+" is not extensible");return d}:null;$jscomp.polyfill("Object.setPrototypeOf",function(d){return d||$jscomp.setPrototypeOf},"es6","es5");
var __extends=this&&this.__extends||function(){var d=function(b,e){d=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(c,a){c.__proto__=a}||function(c,a){for(var g in a)a.hasOwnProperty(g)&&(c[g]=a[g])};return d(b,e)};return function(b,e){function c(){this.constructor=b}d(b,e);b.prototype=null===e?Object.create(e):(c.prototype=e.prototype,new c)}}(),biodeep;
(function(d){(function(b){b.start=function(){Router.AddAppHandler(new apps.PathwayExplorer);Router.AddAppHandler(new apps.FlowEditor);Router.RunApp()}})(d.app||(d.app={}))})(biodeep||(biodeep={}));var __indexOf=Array.prototype.indexOf||function(d){for(var b=0,e=this.length;b<e;b++)if(b in this&&this[b]===d)return b;return-1};$ts.mode=Modes.debug;$ts(biodeep.app.start);var apps;
(function(d){var b=function(){function b(c,a,g,f,b){this.node=c;this.link=a;this.group=g;this.label=f;this.vm=b;console.log(this)}b.prototype.tick=function(){var c=this.vm,a=this;return function(){a.node.each(function(a){return a.innerBounds=a.bounds.inflate(-c.margin)});a.link.each(function(a){return a.route=cola.makeEdgeBetween(a.source.innerBounds,a.target.innerBounds,5)});a.link.attr("x1",function(a){return a.route.sourceIntersection.x}).attr("y1",function(a){return a.route.sourceIntersection.y}).attr("x2",
function(a){return a.route.arrowStart.x}).attr("y2",function(a){return a.route.arrowStart.y});a.label.each(function(a){var g=this.getBBox();a.width=g.width+2*c.margin+8;a.height=g.height+2*c.margin+8});a.node.attr("x",function(a){return a.innerBounds.x}).attr("y",function(a){return a.innerBounds.y}).attr("width",function(a){return a.innerBounds.width()}).attr("height",function(a){return a.innerBounds.height()});a.group.attr("x",function(a){return a.bounds.x}).attr("y",function(a){return a.bounds.y}).attr("width",
function(a){return a.bounds.width()}).attr("height",function(a){return a.bounds.height()});a.label.attr("transform",function(c){return a.transform(c)})}};b.prototype.transform=function(c){return"translate("+c.x+this.vm.margin+", "+(c.y+this.vm.margin-c.height/2)+")"};return b}();d.Cola_graph=b})(apps||(apps={}));
(function(d){var b=function(){function b(){this.width=800;this.height=520;this.margin=6;this.pad=12;this.width=parseFloat($ts("@width"));this.height=parseFloat($ts("@height"))}b.prototype.redraw=function(){this.vis.attr("transform","translate("+d3.event.translate+") scale("+d3.event.scale+")")};b.prototype.savePng=function(){saveSvgAsPng($ts("#canvas").childNodes.item(0),"pathway.png")};b.prototype.init=function(){var c=this,a=$ts("@url:graph");this.d3cola=cola.d3adaptor(d3).linkDistance(60).avoidOverlaps(!0).size([this.width,
...
function(a){return c.d3cola.on("tick",c.loadGraph(JSON.parse(a)).tick())});TypeScript.logging.log("intialization job done!",TypeScript.ConsoleColors.DarkBlue);return this};b.prototype.loadGraph=function(c){var a=this,g=this.vis.append("g"),f=this.vis.append("g"),h=this.vis.append("g");Strings.Empty(c.class)||"GraphLinksModel"!=c.class||(c=d.translation.translateToColaGraph(c));console.log(JSON.stringify(c));this.d3cola.nodes(c.nodes).links(c.links).groups(c.groups).constraints(c.constraints).start();
...
"link");var e=f.selectAll(".node").data(c.nodes).enter().append("rect").attr("class","node").attr("width",function(c){return c.width+2*a.pad+2*a.margin}).attr("height",function(c){return c.height+2*a.pad+2*a.margin}).attr("rx",function(a){return a.rx}).attr("ry",function(a){return a.rx}).call(this.d3cola.drag);c=f.selectAll(".label").data(c.nodes).enter().append("text").attr("class","label").call(this.d3cola.drag);c.each(b.insertLinebreaks);e.append("title").text(function(a){return a.label});return new d.Cola_graph(e,
h,g,c,this)};b.insertLinebreaks=function(c){var a=d3.select(this);c=c.label.split(" ");a.text("");for(var g=0;g<c.length;g++){var f=c[g];f=a.append("tspan").text(f);f.attr("x",0).attr("dy","15").attr("font-size","12")}};return b}();d.Metabolic_pathway=b})(apps||(apps={}));
(function(d){(function(b){b.translateToColaGraph=function(b){for(var c={groups:[],constraints:[],links:[],nodes:[]},a={},g={},f=0,d=b.nodeDataArray;f<d.length;f++){var e=d[f];!isNullOrUndefined(e.isGroup)&&e.isGroup&&(g[e.key.toString()]={leaves:[],padding:10,style:"fill:#4db987;fill-opacity:0.31764700000000001;stroke:#4db987;stroke-opacity:1"})}f=0;for(d=b.nodeDataArray;f<d.length;f++)if(e=d[f],isNullOrUndefined(e.isGroup)||!e.isGroup)c.nodes.push({dunnartid:(c.nodes.length+1).toString(),height:40,
index:c.nodes.length,label:e.label,rx:9,ry:9,width:60,x:0,y:0}),a[e.key]=c.nodes.length-1,isNullOrUndefined(e.group)||g[e.group.toString()].leaves.push(c.nodes.length-1);g=0;for(b=b.linkDataArray;g<b.length;g++)e=b[g],c.links.push({source:a[e.from],target:a[e.to]});return c}})(d.translation||(d.translation={}))})(apps||(apps={}));
(function(d){var b=function(b){function c(){var a=null!==b&&b.apply(this,arguments)||this;a.SD={mode:"pointer",itemType:"pointer",nodeCounter:{stock:0,cloud:0,variable:0,valve:0}};return a}__extends(c,b);Object.defineProperty(c.prototype,"appName",{get:function(){return"FlowEditor"},enumerable:!0,configurable:!0});c.prototype.config=function(){var a=this.SD,c=this;return{"undoManager.isEnabled":!0,allowLink:!1,"animationManager.isEnabled":!1,"linkingTool.portGravity":0,"linkingTool.doActivate":function(){this.temporaryLink.curve=
"flow"===a.itemType?go.Link.Normal:go.Link.Bezier;this.temporaryLink.path.stroke="flow"===a.itemType?"blue":"green";this.temporaryLink.path.strokeWidth="flow"===a.itemType?5:1;go.LinkingTool.prototype.doActivate.call(this)},"linkingTool.insertLink":function(f,b,g,d){c.myDiagram.model.setCategoryForLinkData(this.archetypeLinkData,a.itemType);this.archetypeLabelNodeData="flow"===a.itemType?{category:"valve"}:null;this.archetypeLinkData.text=a.itemType;return go.LinkingTool.prototype.insertLink.call(this,
f,b,g,d)},"clickCreatingTool.archetypeNodeData":{},"commandHandler.archetypeGroupData":{text:"Group",isGroup:!0,color:"blue"},"clickCreatingTool.isDoubleClick":!1,"clickCreatingTool.canStart":function(){return"node"===a.mode&&go.ClickCreatingTool.prototype.canStart.call(this)},"clickCreatingTool.insertPart":function(c){a.nodeCounter[a.itemType]+=1;var b=a.itemType+a.nodeCounter[a.itemType];this.archetypeNodeData={key:b,category:a.itemType,label:b};return go.ClickCreatingTool.prototype.insertPart.call(this,
...
f.category&&(b.startTransaction("updateNode"),c.nodeCounter.valve+=1,a="flow"+c.nodeCounter.valve,f=f.labelNodes.first(),b.model.setDataProperty(f.data,"label",a),b.commitTransaction("updateNode"))});this.buildTemplates();this.load()};c.prototype.buildTemplates=function(){var a=go.GraphObject.make,b=this.myDiagram;b.nodeTemplateMap.add("stock",a(go.Node,d.EditorTemplates.nodeStyle(),a(go.Shape,d.EditorTemplates.shapeStyle(),{desiredSize:new go.Size(50,30)}),a(go.TextBlock,d.EditorTemplates.textStyle(),
{_isNodeLabel:!0,alignment:new go.Spot(.5,.5,0,30)},(new go.Binding("alignment","label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));b.nodeTemplateMap.add("cloud",a(go.Node,d.EditorTemplates.nodeStyle(),a(go.Shape,d.EditorTemplates.shapeStyle(),{figure:"Cloud",desiredSize:new go.Size(35,35)})));b.nodeTemplateMap.add("valve",a(go.Node,d.EditorTemplates.nodeStyle(),{movable:!1,layerName:"Foreground",alignmentFocus:go.Spot.None},a(go.Shape,d.EditorTemplates.shapeStyle(),{figure:"Ellipse",
desiredSize:new go.Size(20,20)}),a(go.TextBlock,d.EditorTemplates.textStyle(),{_isNodeLabel:!0,alignment:new go.Spot(.5,.5,0,20)},(new go.Binding("alignment","label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));b.nodeTemplateMap.add("variable",a(go.Node,d.EditorTemplates.nodeStyle(),{type:go.Panel.Auto},a(go.TextBlock,d.EditorTemplates.textStyle(),{isMultiline:!1}),a(go.Shape,d.EditorTemplates.shapeStyle(),{isPanelMain:!0,stroke:null,fill:"transparent"})));b.linkTemplateMap.add("flow",
a(go.Link,{toShortLength:8},a(go.Shape,{stroke:"blue",strokeWidth:5}),a(go.Shape,{fill:"blue",stroke:null,toArrow:"Standard",scale:2.5})));b.linkTemplateMap.add("influence",a(go.Link,{curve:go.Link.Bezier,toShortLength:8},a(go.Shape,{stroke:"green",strokeWidth:1.5}),a(go.Shape,{fill:"green",stroke:null,toArrow:"Standard",scale:1.5})));b.groupTemplate=a(go.Group,"Vertical",{selectionObjectName:"PANEL",ungroupable:!0},a(go.TextBlock,{font:"bold 19px sans-serif",isMultiline:!1,editable:!0},(new go.Binding("text",
