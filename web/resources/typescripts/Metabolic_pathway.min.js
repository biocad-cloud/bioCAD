...
.5,0,20)},(new go.Binding("alignment","label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));d.nodeTemplateMap.add("variable",a(go.Node,b.EditorTemplates.nodeStyle(),{type:go.Panel.Auto},a(go.TextBlock,b.EditorTemplates.textStyle(),{isMultiline:!1}),a(go.Shape,b.EditorTemplates.shapeStyle(),{isPanelMain:!0,stroke:null,fill:"transparent"})));d.linkTemplateMap.add("flow",a(go.Link,{toShortLength:8},a(go.Shape,{stroke:"blue",strokeWidth:3}),a(go.Shape,{fill:"blue",stroke:null,toArrow:"Standard",
scale:1.5})));d.linkTemplateMap.add("influence",a(go.Link,{curve:go.Link.Bezier,toShortLength:8},a(go.Shape,{stroke:"green",strokeWidth:1.5}),a(go.Shape,{fill:"green",stroke:null,toArrow:"Standard",scale:1.5})));d.groupTemplate=a(go.Group,"Vertical",{selectionObjectName:"PANEL",ungroupable:!0},a(go.TextBlock,{font:"bold 19px sans-serif",isMultiline:!1,editable:!0},(new go.Binding("text","text")).makeTwoWay(),new go.Binding("stroke","color")),a(go.Panel,"Auto",{name:"PANEL"},a(go.Shape,"Rectangle",
{fill:"rgba(128,128,128,0.2)",stroke:"gray",strokeWidth:3,portId:"",cursor:"pointer",fromLinkable:!0,fromLinkableSelfNode:!0,fromLinkableDuplicates:!0,toLinkable:!0,toLinkableSelfNode:!0,toLinkableDuplicates:!0}),a(go.Placeholder,{margin:10,background:"transparent"})),{toolTip:a("ToolTip",a(go.TextBlock,{margin:4},(new go.Binding("text","",c.groupInfo)).ofObject()))})};c.groupInfo=function(a){a=a.adornedPart;var c=a.memberParts.count,b=0;a.memberParts.each(function(a){a instanceof go.Link&&b++});
return"Group "+a.data.key+": "+a.data.text+"\n"+c+" members including "+b+" links"};c.prototype.setMode=function(a,c){var b=this.goCanvas,d=this.SD;b.startTransaction();document.getElementById(d.itemType).className=d.mode+"_normal";document.getElementById(c).className=a+"_selected";d.mode=a;d.itemType=c;"pointer"===a?(b.allowLink=!1,b.nodes.each(function(a){return a.port.cursor=""})):"node"===a?(b.allowLink=!1,b.nodes.each(function(a){return a.port.cursor=""})):"link"===a&&(b.allowLink=!0,b.nodes.each(function(a){return a.port.cursor=
"pointer"}));b.commitTransaction("mode changed")};c.prototype.save_click=function(){this.dosave()};c.prototype.load=function(){var a=this;$ts.getText("@api:load?model_id="+$ts("@data:model_id"),function(c){c=b.ModelPatch(JSON.parse(c));c=JSON.stringify(c);a.goCanvas.model=go.Model.fromJson(c)})};c.prototype.dosave=function(a){void 0===a&&(a=null);var c=this.goCanvas,d=c.model.toJson();d={guid:$ts("@data:model_id"),model:b.ModelPatch(JSON.parse(d)),type:"dynamics"};c.isModified=!1;$ts.post("@api:save",
d,function(c){0!=c.code?console.error(c.info):isNullOrUndefined(c.info)||isNullOrUndefined(a)||a(c.info)})};c.prototype.pointer_click=function(){this.setMode("pointer","pointer")};c.prototype.stock_click=function(){this.setMode("node","stock")};c.prototype.cloud_click=function(){this.setMode("node","cloud")};c.prototype.variable_click=function(){this.setMode("node","variable")};c.prototype.flow_click=function(){this.setMode("link","flow")};c.prototype.influence_click=function(){this.setMode("link",
"influence")};c.prototype.run_click=function(){var a=this;this.dosave(function(c){return a.doRunModel(c)})};c.prototype.doRunModel=function(a){$ts.post("@api:run/"+a,{guid:a},function(a){0!=a.code?console.error(a.info):$goto(a.url)})};return c}(Bootstrap);b.FlowEditor=d})(apps||(apps={}));
