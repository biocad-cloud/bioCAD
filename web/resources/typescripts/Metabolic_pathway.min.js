...
0;for(h=d.nodeDataArray;f<h.length;f++)if(e=h[f],isNullOrUndefined(e.isGroup)||!e.isGroup)e.category="valve";e=0;for(d=d.linkDataArray;e<d.length;e++)f=d[e],c.links.push({source:a[f.from],target:a[f.to]});for(var m in g)c.groups.push(g[m]);return c}})(b.translation||(b.translation={}))})(apps||(apps={}));
...
c)}}};c.prototype.init=function(){var a=go.GraphObject.make,b=this.SD,c=this.myDiagram=a(go.Diagram,"myDiagram",this.config());c.toolManager.mouseMoveTools.insertAt(0,new NodeLabelDraggingTool);c.addDiagramListener("Modified",function(a){a=document.getElementById("SaveButton");var b=document.title.indexOf("*");a&&(a.disabled=!c.isModified);c.isModified?0>b&&(document.title+="*"):0<=b&&(document.title=document.title.substr(0,b))});c.addDiagramListener("LinkDrawn",function(a){var d=a.subject;"flow"===
d.category&&(c.startTransaction("updateNode"),b.nodeCounter.valve+=1,a="flow"+b.nodeCounter.valve,d=d.labelNodes.first(),c.model.setDataProperty(d.data,"label",a),c.commitTransaction("updateNode"))});this.buildTemplates();this.load()};c.prototype.buildTemplates=function(){var a=go.GraphObject.make,d=this.myDiagram;d.nodeTemplateMap.add("stock",a(go.Node,b.EditorTemplates.nodeStyle(),a(go.Shape,b.EditorTemplates.shapeStyle(),{desiredSize:new go.Size(50,30)}),a(go.TextBlock,b.EditorTemplates.textStyle(),
...
a.adornedPart;var c=a.memberParts.count,b=0;a.memberParts.each(function(a){a instanceof go.Link&&b++});return"Group "+a.data.key+": "+a.data.text+"\n"+c+" members including "+b+" links"};c.prototype.setMode=function(a,b){var c=this.myDiagram,d=this.SD;c.startTransaction();document.getElementById(d.itemType).className=d.mode+"_normal";document.getElementById(b).className=a+"_selected";d.mode=a;d.itemType=b;"pointer"===a?(c.allowLink=!1,c.nodes.each(function(a){return a.port.cursor=""})):"node"===a?
(c.allowLink=!1,c.nodes.each(function(a){return a.port.cursor=""})):"link"===a&&(c.allowLink=!0,c.nodes.each(function(a){return a.port.cursor="pointer"}));c.commitTransaction("mode changed")};c.prototype.save_click=function(){this.dosave()};c.prototype.load=function(){var a=this;$ts.getText("@api:load?model_id="+$ts("@data:model_id"),function(c){c=b.ModelPatch(JSON.parse(c));c=JSON.stringify(c);a.myDiagram.model=go.Model.fromJson(c)})};c.prototype.dosave=function(a){void 0===a&&(a=null);var c=this.myDiagram,
