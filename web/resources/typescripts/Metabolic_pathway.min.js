...
(function(b){b.listDiv="#sample_suggests";b.inputDiv="#sample_search";var d=function(d){function c(){return null!==d&&d.apply(this,arguments)||this}__extends(c,d);Object.defineProperty(c.prototype,"appName",{get:function(){return"kegg_network"},enumerable:!0,configurable:!0});c.prototype.init=function(){var a=this,d=PathwayNavigator.parseJsTree(b.PathwayExplorer.loadKEGGTree()),e=[];c.createSet(d,e);d=[];for(var g=0;g<e.length;g++){var l=e[g];d.push(new Application.Suggestion.term(l.id,l.text))}var k=
Application.Suggestion.render.makeSuggestions(d,b.listDiv,function(c){return a.clickOnTerm(c)},13,!0,"");$ts(b.inputDiv).onkeyup=function(){var a=$ts.value(b.inputDiv);Strings.Empty(a,!0)?$ts(b.listDiv).hide():($ts(b.listDiv).show(),k(a))};TypeScript.logging.log(d.length+" kegg components has been loaded!",TypeScript.ConsoleColors.Magenta);TypeScript.logging.log(" ~done!",TypeScript.ConsoleColors.Magenta)};c.prototype.clickOnTerm=function(a){$ts(b.listDiv).hide()};c.createSet=function(a,c){var b=
0;for(a=a.children;b<a.length;b++){var d=a[b];isNullOrUndefined(d.children)?c.push(d):this.createSet(d,c)}};return c}(Bootstrap);b.KEGGNetwork=d})(apps||(apps={}));
