...
Application.Suggestion.render.makeSuggestions(d,b.listDiv,function(c){return a.clickOnTerm(c)},13,!0,"");$ts(b.inputDiv).onkeyup=function(){var a=$ts.value(b.inputDiv);Strings.Empty(a,!0)?$ts(b.listDiv).hide():($ts(b.listDiv).show(),k(a))}};c.prototype.clickOnTerm=function(a){$ts(b.listDiv).hide()};c.createSet=function(a,c){var b=0;for(a=a.children;b<a.length;b++){var d=a[b];isNullOrUndefined(d.children)?c.push(d):this.createSet(d,c)}};return c}(Bootstrap);b.KEGGNetwork=d})(apps||(apps={}));
