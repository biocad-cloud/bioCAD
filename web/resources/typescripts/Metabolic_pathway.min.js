...
$ts("#canvas").clear().display($ts("<iframe>",{src:"@url:readmap/"+f,width:"1600px",height:"1200px","max-width":"1920px",frameborder:"no",border:"0",marginwidth:"0",marginheight:"0",scrolling:"no",allowtransparency:"yes"}))})};c.createReactor=function(a){a="map"+("string"==typeof a?a:a.reference[0].id).split("_")[0];$ts.post("@url:createmap",{mapid:a},function(a){0==a.code&&$goto(a.info)})};c.saveCache=function(a){var c=[],d=0;for(a=a.children;d<a.length;d++){var e=a[d],l=e.name.toLowerCase().replace(/\s+/ig,
"_");c.push(l);localStorage.setItem(l,JSON.stringify(e))}localStorage.setItem(b.assemblyKey,JSON.stringify(c))};c.prototype.loadCache=function(){this.loadUITree(c.loadKEGGTree())};c.loadKEGGTree=function(){var a=localStorage.getItem(b.assemblyKey),c={name:"ko00001",children:[]},d=0;for(a=JSON.parse(a);d<a.length;d++){var e=a[d];TypeScript.logging.log("load cache: "+e+"...");e=localStorage.getItem(e);c.children.push(JSON.parse(e))}return c};return c}(Bootstrap);b.PathwayExplorer=d})(apps||(apps={}));
