...
$ts.get(d,function(b){c.saveCache(b);a()}):a())};c.prototype.loadUITree=function(a){a=PathwayNavigator.parseJsTree(a);var b=$ts("@app:explorer"),d=this;$("#"+b).jstree({core:{data:a.children},plugins:["contextmenu"],contextmenu:{items:{add_reactor:{label:"Create Reactor",action:c.createReactor}}}});$("#"+b).on("click",".jstree-anchor",function(a){var e="map"+$("#"+b).jstree(!0).get_node($(this)).id.split("_")[0];d.Metabolic_pathway=e;$ts("#do-createReactor").onclick=function(){c.createReactor(e)};
$ts("#canvas").clear().display($ts("<iframe>",{src:"@url:readmap/"+e,width:"1600px",height:"1200px","max-width":"1920px",frameborder:"no",border:"0",marginwidth:"0",marginheight:"0",scrolling:"no",allowtransparency:"yes"}))})};c.createReactor=function(a){a="map"+("string"==typeof a?a:a.reference[0].id).split("_")[0];$ts.post("@url:createmap",{mapid:a},function(a){var b=c.getUrl(a);0!=a.code||Strings.Empty(b,!0)||$goto(b)})};c.getUrl=function(a){return isNullOrUndefined(a)||"string"!=typeof a.info?
null:a.info};c.saveCache=function(a){var c=[],d=0;for(a=a.children;d<a.length;d++){var f=a[d],l=f.name.toLowerCase().replace(/\s+/ig,"_");c.push(l);localStorage.setItem(l,JSON.stringify(f))}localStorage.setItem(b.assemblyKey,JSON.stringify(c))};c.prototype.loadCache=function(){this.loadUITree(c.loadKEGGTree())};c.loadKEGGTree=function(){var a=localStorage.getItem(b.assemblyKey),c={name:"ko00001",children:[]},d=0;for(a=JSON.parse(a);d<a.length;d++){var f=a[d];TypeScript.logging.log("load cache: "+
f+"...");f=localStorage.getItem(f);c.children.push(JSON.parse(f))}return c};return c}(Bootstrap);b.PathwayExplorer=d})(apps||(apps={}));var PathwayNavigator;
