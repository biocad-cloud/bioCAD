...
$jscomp.polyfill=function(b,f,e,c){if(f){e=$jscomp.global;b=b.split(".");for(c=0;c<b.length-1;c++){var d=b[c];d in e||(e[d]={});e=e[d]}b=b[b.length-1];c=e[b];f=f(c);f!=c&&null!=f&&$jscomp.defineProperty(e,b,{configurable:!0,writable:!0,value:f})}};$jscomp.underscoreProtoCanBeSet=function(){var b={a:!0},f={};try{return f.__proto__=b,f.a}catch(e){}return!1};
$jscomp.setPrototypeOf="function"==typeof Object.setPrototypeOf?Object.setPrototypeOf:$jscomp.underscoreProtoCanBeSet()?function(b,f){b.__proto__=f;if(b.__proto__!==f)throw new TypeError(b+" is not extensible");return b}:null;$jscomp.polyfill("Object.setPrototypeOf",function(b){return b||$jscomp.setPrototypeOf},"es6","es5");
var __extends=this&&this.__extends||function(){var b=function(f,e){b=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(c,d){c.__proto__=d}||function(c,d){for(var a in d)d.hasOwnProperty(a)&&(c[a]=d[a])};return b(f,e)};return function(f,e){function c(){this.constructor=f}b(f,e);f.prototype=null===e?Object.create(e):(c.prototype=e.prototype,new c)}}(),biodeep;
(function(b){(function(b){b.start=function(){Router.AddAppHandler(new apps.Metabolic_pathway);Router.AddAppHandler(new apps.PathwayExplorer);Router.RunApp()}})(b.app||(b.app={}))})(biodeep||(biodeep={}));$ts.mode=Modes.debug;$ts(biodeep.app.start);var apps;
(function(b){var f=function(){function b(c,d,a,b,e){this.node=c;this.link=d;this.group=a;this.label=b;this.vm=e;console.log(this)}b.prototype.tick=function(){var c=this.vm,d=this;return function(){d.node.each(function(a){return a.innerBounds=a.bounds.inflate(-c.margin)});d.link.each(function(a){return a.route=cola.makeEdgeBetween(a.source.innerBounds,a.target.innerBounds,5)});d.link.attr("x1",function(a){return a.route.sourceIntersection.x}).attr("y1",function(a){return a.route.sourceIntersection.y}).attr("x2",
function(a){return a.route.arrowStart.x}).attr("y2",function(a){return a.route.arrowStart.y});d.label.each(function(a){var d=this.getBBox();a.width=d.width+2*c.margin+8;a.height=d.height+2*c.margin+8});d.node.attr("x",function(a){return a.innerBounds.x}).attr("y",function(a){return a.innerBounds.y}).attr("width",function(a){return a.innerBounds.width()}).attr("height",function(a){return a.innerBounds.height()});d.group.attr("x",function(a){return a.bounds.x}).attr("y",function(a){return a.bounds.y}).attr("width",
function(a){return a.bounds.width()}).attr("height",function(a){return a.bounds.height()});d.label.attr("transform",function(a){return d.transform(a)})}};b.prototype.transform=function(c){return"translate("+c.x+this.vm.margin+", "+(c.y+this.vm.margin-c.height/2)+")"};return b}();b.Cola_graph=f})(apps||(apps={}));
(function(b){var f=function(){function e(){this.width=800;this.height=520;this.margin=6;this.pad=12;this.width=parseFloat($ts("@width"));this.height=parseFloat($ts("@height"))}e.prototype.redraw=function(){this.vis.attr("transform","translate("+d3.event.translate+") scale("+d3.event.scale+")")};e.prototype.savePng=function(){saveSvgAsPng($ts("#canvas").childNodes.item(0),"pathway.png")};e.prototype.init=function(){var c=this,d=$ts("@url:graph");this.d3cola=cola.d3adaptor(d3).linkDistance(60).avoidOverlaps(!0).size([this.width,
