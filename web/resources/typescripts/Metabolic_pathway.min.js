...
(function(b){b.assemblyKey="ko00001-assembly";var d=function(d){function c(){var a=null!==d&&d.apply(this,arguments)||this;a.canvas=new b.Metabolic_pathway;return a}__extends(c,d);Object.defineProperty(c.prototype,"appName",{get:function(){return"Pathway_explorer"},enumerable:!0,configurable:!0});c.prototype.init=function(){var a=this;c.initKEGG(function(){return a.loadCache()});this.canvas.init()};c.initKEGG=function(a){var d=$ts("@data:repository"),f=localStorage.getItem(b.assemblyKey);Strings.Empty(d,
!0)||(Strings.Empty(f)?$ts.get(d,function(b){c.saveCache(b);a()}):a())};c.prototype.loadUITree=function(a){a=PathwayNavigator.parseJsTree(a);var b=$ts("@app:explorer");$("#"+b).jstree({core:{data:a.children},plugins:["contextmenu"],contextmenu:{items:{add_reactor:{label:"Add Reactor",action:c.addReactor}}}});$("#"+b).on("click",".jstree-anchor",function(a){a=$("#"+b).jstree(!0).get_node($(this)).id;console.log(a)})};c.addReactor=function(a){a.reference[0].id.match(/K\d{4,}/g)};c.saveCache=function(a){var c=
[],d=0;for(a=a.children;d<a.length;d++){var e=a[d],l=e.name.toLowerCase().replace(/\s+/ig,"_");c.push(l);localStorage.setItem(l,JSON.stringify(e))}localStorage.setItem(b.assemblyKey,JSON.stringify(c))};c.prototype.loadCache=function(){this.loadUITree(c.loadKEGGTree())};c.loadKEGGTree=function(){var a=localStorage.getItem(b.assemblyKey),c={name:"ko00001",children:[]},d=0;for(a=JSON.parse(a);d<a.length;d++){var e=a[d];TypeScript.logging.log("load cache: "+e+"...");e=localStorage.getItem(e);c.children.push(JSON.parse(e))}return c};
return c}(Bootstrap);b.PathwayExplorer=d})(apps||(apps={}));var PathwayNavigator;
