...
d.prototype.doRunModel=function(a){$ts.post("@api:run/"+a,{guid:a},function(a){0!=a.code?console.error(a.info):$goto(a.url)})};return d}(Bootstrap);c.FlowEditor=b})(apps||(apps={}));
