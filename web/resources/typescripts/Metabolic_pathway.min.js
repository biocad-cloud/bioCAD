...
function(a){return c.d3cola.on("tick",c.loadGraph(JSON.parse(a)).tick())});TypeScript.logging.log("intialization job done!",TypeScript.ConsoleColors.DarkBlue);return this};b.prototype.loadGraph=function(c){var a=this,f=this.vis.append("g"),g=this.vis.append("g"),l=this.vis.append("g");console.log(JSON.stringify(c));this.d3cola.nodes(c.nodes).links(c.links).groups(c.groups).constraints(c.constraints).start();this.outer.append("svg:defs").append("svg:marker").attr("id","end-arrow").attr("viewBox","0 -5 10 10").attr("refX",
5).attr("markerWidth",3).attr("markerHeight",3).attr("orient","auto").append("svg:path").attr("d","M0,-5L10,0L0,5L2,0").attr("stroke-width","0px").attr("fill","#000");f=f.selectAll(".group").data(c.groups).enter().append("rect").attr("rx",8).attr("ry",8).attr("class","group").attr("style",function(a){return a.style});l=l.selectAll(".link").data(c.links).enter().append("line").attr("class","link");var e=g.selectAll(".node").data(c.nodes).enter().append("rect").attr("class","node").attr("width",function(c){return c.width+
2*a.pad+2*a.margin}).attr("height",function(c){return c.height+2*a.pad+2*a.margin}).attr("rx",function(a){return a.rx}).attr("ry",function(a){return a.rx}).call(this.d3cola.drag);c=g.selectAll(".label").data(c.nodes).enter().append("text").attr("class","label").call(this.d3cola.drag);c.each(b.insertLinebreaks);e.append("title").text(function(a){return a.label});return new d.Cola_graph(e,l,f,c,this)};b.insertLinebreaks=function(c){var a=d3.select(this);c=c.label.split(" ");a.text("");for(var b=0;b<
c.length;b++){var d=c[b];d=a.append("tspan").text(d);d.attr("x",0).attr("dy","15").attr("font-size","12")}};return b}();d.Metabolic_pathway=b})(apps||(apps={}));
...
"flow"===a.itemType?go.Link.Normal:go.Link.Bezier;this.temporaryLink.path.stroke="flow"===a.itemType?"blue":"green";this.temporaryLink.path.strokeWidth="flow"===a.itemType?5:1;go.LinkingTool.prototype.doActivate.call(this)},"linkingTool.insertLink":function(b,d,f,e){c.myDiagram.model.setCategoryForLinkData(this.archetypeLinkData,a.itemType);this.archetypeLabelNodeData="flow"===a.itemType?{category:"valve"}:null;this.archetypeLinkData.text=a.itemType;return go.LinkingTool.prototype.insertLink.call(this,
b,d,f,e)},"clickCreatingTool.archetypeNodeData":{},"clickCreatingTool.isDoubleClick":!1,"clickCreatingTool.canStart":function(){return"node"===a.mode&&go.ClickCreatingTool.prototype.canStart.call(this)},"clickCreatingTool.insertPart":function(c){a.nodeCounter[a.itemType]+=1;var b=a.itemType+a.nodeCounter[a.itemType];this.archetypeNodeData={key:b,category:a.itemType,label:b};return go.ClickCreatingTool.prototype.insertPart.call(this,c)}}};c.prototype.init=function(){var a=go.GraphObject.make,c=this.SD,
b=this.myDiagram=a(go.Diagram,"myDiagram",this.config());b.toolManager.mouseMoveTools.insertAt(0,new NodeLabelDraggingTool);b.addDiagramListener("Modified",function(a){if(a=document.getElementById("SaveButton"))a.disabled=!b.isModified;a=document.title.indexOf("*");b.isModified?0>a&&(document.title+="*"):0<=a&&(document.title=document.title.substr(0,a))});b.addDiagramListener("LinkDrawn",function(a){var d=a.subject;"flow"===d.category&&(b.startTransaction("updateNode"),c.nodeCounter.valve+=1,a="flow"+
c.nodeCounter.valve,d=d.labelNodes.first(),b.model.setDataProperty(d.data,"label",a),b.commitTransaction("updateNode"))});this.buildTemplates();this.load()};c.prototype.buildTemplates=function(){var a=go.GraphObject.make,c=this.myDiagram;c.nodeTemplateMap.add("stock",a(go.Node,d.EditorTemplates.nodeStyle(),a(go.Shape,d.EditorTemplates.shapeStyle(),{desiredSize:new go.Size(50,30)}),a(go.TextBlock,d.EditorTemplates.textStyle(),{_isNodeLabel:!0,alignment:new go.Spot(.5,.5,0,30)},(new go.Binding("alignment",
"label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));c.nodeTemplateMap.add("cloud",a(go.Node,d.EditorTemplates.nodeStyle(),a(go.Shape,d.EditorTemplates.shapeStyle(),{figure:"Cloud",desiredSize:new go.Size(35,35)})));c.nodeTemplateMap.add("valve",a(go.Node,d.EditorTemplates.nodeStyle(),{movable:!1,layerName:"Foreground",alignmentFocus:go.Spot.None},a(go.Shape,d.EditorTemplates.shapeStyle(),{figure:"Ellipse",desiredSize:new go.Size(20,20)}),a(go.TextBlock,d.EditorTemplates.textStyle(),{_isNodeLabel:!0,
alignment:new go.Spot(.5,.5,0,20)},(new go.Binding("alignment","label_offset",go.Spot.parse)).makeTwoWay(go.Spot.stringify))));c.nodeTemplateMap.add("variable",a(go.Node,d.EditorTemplates.nodeStyle(),{type:go.Panel.Auto},a(go.TextBlock,d.EditorTemplates.textStyle(),{isMultiline:!1}),a(go.Shape,d.EditorTemplates.shapeStyle(),{isPanelMain:!0,stroke:null,fill:"transparent"})));c.linkTemplateMap.add("flow",a(go.Link,{toShortLength:8},a(go.Shape,{stroke:"blue",strokeWidth:5}),a(go.Shape,{fill:"blue",stroke:null,
toArrow:"Standard",scale:2.5})));c.linkTemplateMap.add("influence",a(go.Link,{curve:go.Link.Bezier,toShortLength:8},a(go.Shape,{stroke:"green",strokeWidth:1.5}),a(go.Shape,{fill:"green",stroke:null,toArrow:"Standard",scale:1.5})))};c.prototype.setMode=function(a,c){var b=this.myDiagram,d=this.SD;b.startTransaction();document.getElementById(d.itemType).className=d.mode+"_normal";document.getElementById(c).className=a+"_selected";d.mode=a;d.itemType=c;"pointer"===a?(b.allowLink=!1,b.nodes.each(function(a){a.port.cursor=
""})):"node"===a?(b.allowLink=!1,b.nodes.each(function(a){a.port.cursor=""})):"link"===a&&(b.allowLink=!0,b.nodes.each(function(a){a.port.cursor="pointer"}));b.commitTransaction("mode changed")};c.prototype.save_click=function(){this.dosave()};c.prototype.load=function(){var a=this;$ts.getText("@api:load?model_id="+$ts("@data:model_id"),function(c){a.myDiagram.model=go.Model.fromJson(c)})};c.prototype.dosave=function(a){void 0===a&&(a=null);var c=this.myDiagram,b=c.model.toJson();b={guid:$ts("@data:model_id"),
model:JSON.parse(b),type:"dynamics"};c.isModified=!1;$ts.post("@api:save",b,function(c){0!=c.code?console.error(c.info):isNullOrUndefined(c.info)||a(c.info)})};c.prototype.pointer_click=function(){this.setMode("pointer","pointer")};c.prototype.stock_click=function(){this.setMode("node","stock")};c.prototype.cloud_click=function(){this.setMode("node","cloud")};c.prototype.variable_click=function(){this.setMode("node","variable")};c.prototype.flow_click=function(){this.setMode("link","flow")};c.prototype.influence_click=
function(){this.setMode("link","influence")};c.prototype.run_click=function(){var a=this;this.dosave(function(c){return a.doRunModel(c)})};c.prototype.doRunModel=function(a){$ts.post("@api:run/"+a,{guid:a},function(a){0!=a.code?console.error(a.info):$goto(a.url)})};return c}(Bootstrap);d.FlowEditor=b})(apps||(apps={}));
...
target:this.nodeLookup[d].index}):console.warn("missing node of "+d):console.warn("missing node of "+e)}a=0;for(b=this.sbsvg.selectAll(".cluster")[0];a<b.length;a++)e=b[a],this.graph.groups.push({leaves:e.getAttribute("dunnart:contains").split(" ").map(function(a){return c.nodeLookup[a].index}),style:e.getAttribute("style"),padding:10});a={};b=0;for(e=this.sbsvg.selectAll("[relType=alignment]")[0];b<e.length;b++){var h=e[b];d=h.getAttribute("constraintid");var k=this.nodeLookup[h.getAttribute("objoneid")].index;
h=parseInt(h.getAttribute("alignmentpos"));k={node:k,offset:0};d in a?a[d].offsets.push(k):this.graph.constraints.push(a[d]={type:"alignment",offsets:[k],axis:1==h?"y":"x"})}return this.graph};b.prototype.loadNodes=function(b){var a=0,c=0;for(b=b.selectAll("rect.shape")[0];c<b.length;c++){var d=b[c];this.graph.nodes.push(this.nodeLookup[d.id]={label:d.getAttribute("dunnart:label"),dunnartid:d.id,index:a++,width:60,height:40,x:parseFloat(d.getAttribute("x")),y:parseFloat(d.getAttribute("y")),rx:"rx"in
