...
new go.Binding("text","key"))));d.nodeTemplateMap.add("cloud",a(go.Node,b.EditorTemplates.nodeStyle(),a(go.Shape,b.EditorTemplates.shapeStyle(),{figure:"Cloud",desiredSize:new go.Size(35,35)})));d.nodeTemplateMap.add("valve",a(go.Node,b.EditorTemplates.nodeStyle(),{movable:!1,layerName:"Foreground",alignmentFocus:go.Spot.None},a(go.Shape,b.EditorTemplates.shapeStyle(),{figure:"Ellipse",desiredSize:new go.Size(5,5)}),a(go.TextBlock,b.EditorTemplates.textStyle(4),{_isNodeLabel:!0,alignment:new go.Spot(.5,
