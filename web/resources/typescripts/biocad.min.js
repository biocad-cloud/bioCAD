...
(function(a){(function(a){(function(a){var b=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"reportViewer"},enumerable:!0,configurable:!0});b.prototype.makeChart=function(a,b){var c=a.headers.Where(function(a){return""!=a}).Select(function(b){var c=a.Column(b).Skip(1).Select(function(a,b){return[b,parseFloat(a)]});return{name:b,type:"line",smooth:!0,showSymbol:!1,clip:!0,data:c.ToArray(),emphasis:{focus:"series"},
ymax:c.Select(function(a){return a[1]}).Max()}}).ToArray(),d={animation:!1,title:"PLAS.NET Systems Dynamics",tooltip:{trigger:"axis",axisPointer:{type:"cross"}},legend:{},grid:{top:40,left:50,right:40,bottom:50},xAxis:{name:"Time(ticks)",minorTick:{show:!0},minorSplitLine:{show:!0},nameLocation:"middle"},yAxis:{name:"Activity",min:0,max:$from(c).Select(function(a){return a.ymax}).Max(),minorTick:{show:!0},minorSplitLine:{show:!0}},series:c};console.log("lines:");console.log(c);d&&b.setOption(d)};
b.prototype.init=function(){var a=this,b=document.getElementById("main"),c=echarts.init(b);$ts.getText("@data:PLAS",function(b){return a.makeChart($ts.csv(b,!1),c)})};return b}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
...
a.sha1+'" target="__blank">\n                                <h4 class="mb-0">'+a.title+"</h4>\n                            </a>                            \n                        </div>")),e=$ts("<td>").appendElement(a.create_time),f=$ts("<td>").appendElement(k[b(a.status)]),l=$ts("<td>").appendElement(a.finish_time||"n/a");a=$ts("<td>").appendElement(h[b(a.status)]);c=$ts("<td>",{class:"text-right"}).appendElement(g.replace("{$model_url}",c));return $ts("<tr>").appendElement(d).appendElement(e).appendElement(f).appendElement(l).appendElement(a).appendElement(c)};
return c}(Bootstrap);a.TaskMgr=c;var g='\n        <div class="dropdown">\n            <a class="btn btn-sm btn-icon-only text-light" href="#" role="button"\n                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"\n                style="box-shadow: none;">\n\n                <i class="fas fa-ellipsis-v"></i>\n            </a>\n            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">\n                <a class="dropdown-item bg-danger" href="#">Delete</a>\n                <a class="dropdown-item" href="{$model_url}">View Model</a>\n                <a class="dropdown-item" href="#">Help</a>\n            </div>\n        </div>\n    ',
