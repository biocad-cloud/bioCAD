...
(function(a){(function(a){a.show=function(b,f,c){var d=$ts(b),l=$from(c).ToDictionary(function(a){return a.classID.toString()},function(a){return a}),m=$from(c).ToDictionary(function(a){return a.classID.toString()},function(a){return a.class});f=$from(f).Select(function(c){return new a.bioCADFile(c,l)}).Select(function(c){var g=m.Item(c.mime.contentType);g=a.bioMimeTypes.classToFontAwsome(g);return new a.FileHandle(c,g)});d.classList.contains(containerClassName)||d.classList.add(containerClassName);
c=0;for(var h=f.ToArray();c<h.length;c++)d.appendChild(h[c].getNode());return{container:d,files:f.ToArray(),divId:b}}})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));(function(a){(function(a){var b=function(){function a(a,d){this.id=a.id;this.fileName=a.name;this.size=a.size;this.mime=d.Item(a.content_type)}a.prototype.toString=function(){return this.fileName};return a}();a.bioCADFile=b})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));
...
a.prototype.getNode=function(){var a=this.mimeIcon[0],d=this.mimeIcon[1];a=$ts("<div>",{class:"kv-file-content"}).display($ts("<div>",{class:["kv-preview-data","file-preview-other-frame"],style:"width:auto;height:auto;max-width:100%;max-height:100%;"}).display('\n                <div class="file-preview-other">\n                    <span class="file-other-icon">\n                        <center>\n                            <div style="max-width: 128px; height: 50px; color: '+d+';">\n                                '+
a+"\n                            </div>\n                        </center>\n                    </span>\n                </div>\n            "));d=$ts("<div>",{class:"file-thumbnail-footer"}).appendElement(this.footer()).appendElement(this.actionButtons()).appendElement($ts("<div>",{class:"clearfix"}));return $ts("<div>",{class:["file-preview-frame","krajee-default","file-preview-initial","file-sortable","kv-preview-thumb"],id:"r-"+this.fileId,"data-fileindex":this.fileId,"data-template":"image",
title:this.file.fileName}).appendElement(a).appendElement(d)};a.classNames=["file-preview-frame","krajee-default","file-preview-initial","file-sortable","kv-preview-thumb"];return a}();a.FileHandle=b})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));
...
a.classToFontAwsome=function(a){var g=BioCAD.MIME.bioClassType;return a==g.text?[b(d),"green"]:a==g.image?[b(l),"red"]:a==g.matrix?[b(m),"darkgreen"]:a==g.bioSequence?[b(c),"lightblue"]:a==g.model?[b(t),"brown"]:[b(h),"gray"]}})(a.bioMimeTypes||(a.bioMimeTypes={}))})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));
(function(a){(function(a){(function(b){function f(a,b,m,h,f,g,e,q){void 0===f&&(f=10);void 0===g&&(g=!1);void 0===e&&(e=null);void 0===q&&(q=null);var d=$ts(m);d&&(d.clear(),a.populateSuggestion(b,f,g).forEach(function(a){d.appendChild(c(a,q,h))}),isNullOrUndefined(e)||a.hasEquals(b,g)||(a=$ts("<a>",{href:executeJavaScript,text:b,title:b,onclick:function(){e(b)}}).display("add '"+b+"'"),d.append($ts("<div>",{class:q}).display(a))))}function c(a,c,b){var d=$ts("<a>",{href:executeJavaScript,text:a.term,
title:a.term,onclick:function(){b(a)}}).display(a.term);return $ts("<div>",{class:c}).display(d)}b.makeSuggestions=function(c,b,m,h,e,g,u){void 0===h&&(h=10);void 0===e&&(e=!1);void 0===g&&(g=null);void 0===u&&(u=null);var d=new a.suggestion(c);return function(a){f(d,a,b,m,h,e,u,g)}}})(a.render||(a.render={}))})(a.Suggestion||(a.Suggestion={}))})(Application||(Application={}));
(function(a){(function(a){var b=function(){function b(a){this.terms=a}b.prototype.hasEquals=function(a,b){void 0===b&&(b=!1);b||(a=a.toLowerCase());for(var c=0,d=this.terms;c<d.length;c++){var h=d[c];if(b){if(h.term.toLowerCase()==a)return!0}else if(h.term==a)return!0}return!1};b.prototype.populateSuggestion=function(c,d,l){void 0===d&&(d=5);void 0===l&&(l=!1);var m=c.toLowerCase(),h=$from(this.terms).Select(function(a){var g=b.getScore(a,c,m,l);return{term:a,score:g}}).OrderBy(function(a){return a.score}),
e=h.Where(function(b){return b.score!=a.NA}).Take(d).Select(function(a){return a.term}).ToArray();return e.length==d?e:b.makeAdditionalSuggestion(h,e,l,c,d)};b.makeAdditionalSuggestion=function(a,b,l,e,h){var c=e.toLowerCase();a=a.Skip(b.length).Select(function(a){a=a.term;var b=l?Levenshtein.ComputeDistance(a.term.toLowerCase(),c):Levenshtein.ComputeDistance(a.term,e);return{term:a,score:b}}).OrderBy(function(a){return a.score}).Take(h-b.length).Select(function(a){return a.term}).ToArray();return b.concat(a)};
