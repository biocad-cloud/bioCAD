...
function(a){console.log(a)})};b.prototype.makeChartInternal=function(a){var b=TypeScript.Data.quantile(a.Select(function(a){return a.ymax}).ToArray(),.65),c=this.myChart;b={animation:!1,tooltip:{trigger:"none",axisPointer:{type:"cross"}},legend:{},grid:{top:40,left:50,right:40,bottom:50},xAxis:{name:"Time(ticks)",minorTick:{show:!0},minorSplitLine:{show:!0},nameLocation:"middle"},yAxis:{name:"Activity",min:0,max:b,minorTick:{show:!0},minorSplitLine:{show:!0}},series:a.ToArray()};console.log("lines:");
console.log(a);b&&c.setOption(b,!0,!1)};b.prototype.init=function(){var a=this,b=document.getElementById("main"),c=echarts.init(b);$ts.getText("@data:PLAS",function(b){return a.makeChart($ts.csv(b,!1),c)});$ts.getText("@url:graph",function(b){return a.initPathwaySelector(JSON.parse(b))})};b.prototype.initPathwaySelector=function(a){var b=$ts("#pathway_list"),c=$ts("<optgroup>",{label:"Pathways"}),d=$ts("<optgroup>",{label:"Metabolites"}),l=this.pathways,q=this;c.appendChild($ts("<option>",{value:"*"}).display("*"));
for(var g=0,m=a.nodeDataArray;g<m.length;g++){var e=m[g];if(e.isGroup){var f={pathway:e.label,keys:[]},h=$ts("<option>",{value:e.key});h.innerText=e.text;l.Add(e.key.toString(),f);c.appendChild(h)}}g=0;for(a=a.nodeDataArray;g<a.length;g++)e=a[g],!isNullOrUndefined(e.isGroup)&&e.isGroup||Strings.Empty(e.group,!0)||(m=l.Item(e.group.toString()),h=$ts("<option>",{value:e.label}),h.innerText=e.label,m.keys.push(e.label),"valve"==e.category||Strings.Empty(e.label,!0)||d.appendChild(h));b.add(c);b.add(d);
b.onchange=function(){var a=$ts.select.getOption("#pathway_list");isNullOrUndefined(a)||Strings.Empty(a)||q.updateChart(a.toString())}};return b}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
