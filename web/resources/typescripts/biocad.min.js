...
(function(a){(function(a){(function(a){var b=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"reportViewer"},enumerable:!0,configurable:!0});b.prototype.makeChart=function(a,b){var c=a.headers.Where(function(a){return""!=a}).Select(function(b){return{name:b,type:"line",smooth:!0,showSymbol:!1,clip:!0,data:a.Column(b).Skip(1).Select(function(a,b){return[b,parseFloat(a)]}).ToArray(),emphasis:{focus:"series"}}}).ToArray(),
d={animation:!1,tooltip:{trigger:"none",axisPointer:{type:"cross"}},legend:{},grid:{top:40,left:50,right:40,bottom:50},xAxis:{name:"Time(ticks)",minorTick:{show:!0},minorSplitLine:{show:!0}},yAxis:{name:"Activity",min:0,max:10,minorTick:{show:!0},minorSplitLine:{show:!0}},series:c};console.log("lines:");console.log(c);d&&b.setOption(d)};b.prototype.init=function(){var a=this,b=document.getElementById("main"),c=echarts.init(b);$ts.getText("@data:PLAS",function(b){return a.makeChart($ts.csv(b,!1),c)})};
