...
c.prototype.taskRow=function(a){var c="/biostack/pathway_design/flowEditor?guid="+this.getModelId(a),d=$ts("<th>").appendElement($ts("<div>",{class:["media","align-items-center"]}).appendElement('\n                        <a href="#" class="avatar rounded-circle mr-3">\n                            <img alt="Image placeholder"\n                                src="/resources/images/icons/'+a.name+'.png">\n                        </a>').appendElement('\n                        <div class="media-body">\n                            <a href="/app/report/?q='+
