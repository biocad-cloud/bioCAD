...
keys:[]},e=$ts("<option>",{value:f.key}).display(f.label);c.Add(f.key,n);b.appendChild(e)}}c=0;for(a=a.nodeDataArray;c<a.length;c++)f=a[c],f.isGroup||Strings.Empty(f.group,!0)||this.pathways.Item(f.group).keys.push(f.label);b.onselectionchange=function(a,b){console.log(b)}};return b}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
