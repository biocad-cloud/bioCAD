...
(function(a){(function(a){(function(a){var b=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"reportViewer"},enumerable:!0,configurable:!0});b.prototype.makeChart=function(a,b){var c=a.headers,d=a.Select(function(a,b){return b}).ToArray();c=c.Where(function(a){return""!=a}).Select(function(b){return{name:b,type:"line",smooth:!0,data:a.Column(b).Skip(1).Select(function(a){return parseFloat(a)}).ToArray()}}).ToArray();
var f={xAxis:{type:"value",data:d},yAxis:{type:"value"},series:c};console.log("x axis:");console.log(d);console.log("lines:");console.log(c);f&&b.setOption(f)};b.prototype.init=function(){var a=this,b=document.getElementById("main"),c=echarts.init(b);$ts.getText("@data:PLAS",function(b){return a.makeChart($ts.csv(b,!1),c)})};return b}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
