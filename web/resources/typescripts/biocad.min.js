...
var __extends=this&&this.__extends||function(){var a=function(b,e){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,c){a.__proto__=c}||function(a,c){for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b])};return a(b,e)};return function(b,e){function d(){this.constructor=b}a(b,e);b.prototype=null===e?Object.create(e):(d.prototype=e.prototype,new d)}}(),bioCAD;
...
(function(a){(function(a){(function(a){a.listDiv="#sample_suggests";a.inputDiv="#sample_search";var b=function(c){function b(){var a=null!==c&&c.apply(this,arguments)||this;a.pathways=new Dictionary;a.data={y:new IEnumerator([])};return a}__extends(b,c);Object.defineProperty(b.prototype,"appName",{get:function(){return"reportViewer"},enumerable:!0,configurable:!0});b.prototype.updateChart=function(a){var b=this;this.makeChartInternal(function(){if("*"==a)return b.data.y;if(b.pathways.ContainsKey(a)){var c=
b.pathways.Item(a),h=$from(c.keys);return b.data.y.Where(function(a){return h.Any(function(b){return b==a.name})})}return b.data.y.Where(function(b){return a==b.name})}())};b.parseData=function(a){return a.headers.Where(function(a){return""!=a}).Select(function(b){var c=a.Column(b).Skip(1).Select(function(a,b){return[b,parseFloat(a)]});return{name:b,type:"line",smooth:!0,showSymbol:!1,clip:!0,data:c.ToArray(),emphasis:{focus:"series"},ymax:c.Select(function(a){return a[1]}).Max()}})};b.prototype.makeChart=
function(a,c){var h=$ts.csv(a,!1);h=b.parseData(h);this.csvText=a;this.myChart=c;this.data.y=h;this.makeChartInternal(h);c.on("legendselectchanged",function(a){console.log(a)})};b.prototype.makeChartInternal=function(a){var b=TypeScript.Data.quantile(a.Select(function(a){return a.ymax}).ToArray(),.65),c=this.myChart;b={animation:!1,tooltip:{trigger:"none",axisPointer:{type:"cross"}},legend:{},grid:{top:40,left:50,right:40,bottom:50},xAxis:{name:"Time(ticks)",minorTick:{show:!0},minorSplitLine:{show:!0},
nameLocation:"middle"},yAxis:{name:"Activity",min:0,max:Math.round(1.25*b),minorTick:{show:!0},minorSplitLine:{show:!0}},series:a.ToArray()};console.log("lines:");console.log(a);b&&c.setOption(b,!0,!1)};b.prototype.init=function(){var a=this,b=document.getElementById("main"),c=echarts.init(b);$ts.getText("@data:PLAS",function(b){return a.makeChart(b,c)});$ts.getText("@url:graph",function(b){return a.initPathwaySelector(JSON.parse(b))})};b.prototype.getPLAS_onclick=function(){DOM.download("PLAS_output.csv",
this.csvText,!1)};b.prototype.initPathwaySelector=function(b){var c=this,k=$ts("#pathway_list"),h=$ts("<optgroup>",{label:"Pathways"}),g=$ts("<optgroup>",{label:"Metabolites"}),d=this.pathways,e=this,v=[];h.appendChild($ts("<option>",{value:"*"}).display("*"));for(var p=0,t=b.nodeDataArray;p<t.length;p++){var f=t[p];if(f.isGroup){var x={pathway:f.label,keys:[]},q=$ts("<option>",{value:f.key}),w=new uikit.suggestion_list.term(f.key,f.text);q.innerText=f.text;v.push(w);d.Add(f.key.toString(),x);h.appendChild(q)}}p=
0;for(b=b.nodeDataArray;p<b.length;p++)f=b[p],!isNullOrUndefined(f.isGroup)&&f.isGroup||Strings.Empty(f.group,!0)||(t=d.Item(f.group.toString()),q=$ts("<option>",{value:f.label}),w=new uikit.suggestion_list.term(f.label,f.label),q.innerText=f.label,t.keys.push(f.label),"valve"==f.category||Strings.Empty(f.label,!0)||(v.push(w),g.appendChild(q)));k.add(h);k.add(g);k.onchange=function(){var a=$ts.select.getOption("#pathway_list");isNullOrUndefined(a)||Strings.Empty(a)||e.updateChart(a.toString())};
var y=uikit.suggestion_list.render.makeSuggestions(v,a.listDiv,function(a){return c.clickOnTerm(a)},5,!1,"");$ts(a.inputDiv).onkeyup=function(){var b=$ts.value(a.inputDiv);Strings.Empty(b,!0)?$ts(a.listDiv).hide():($ts(a.listDiv).show(),y(b))}};b.prototype.clickOnTerm=function(b){$ts.value("#pathway_list",b.id.toString());$ts(a.listDiv).hide();this.updateChart(b.id)};return b}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
...
c.prototype.taskRow=function(a){var c=a.app_view+"?guid="+this.getModelId(a),d=$ts("<th>").appendElement($ts("<div>",{class:["media","align-items-center"]}).appendElement('\n                        <a href="#" class="avatar rounded-circle mr-3">\n                            <img alt="Image placeholder"\n                                src="/resources/images/icons/'+a.name+'.png">\n                        </a>').appendElement('\n                        <div class="media-body">\n                            <a href="/task/report/?q='+
a.sha1+'" target="__blank">\n                                <h4 class="mb-0">'+a.title+"</h4>\n                            </a>                            \n                        </div>")),g=$ts("<td>").appendElement(a.create_time),m=$ts("<td>").appendElement(e[b(a.status)]),u=$ts("<td>").appendElement(a.finish_time||"n/a");a=$ts("<td>").appendElement(h[b(a.status)]);c=$ts("<td>",{class:"text-right"}).appendElement(k.replace("{$model_url}",c));return $ts("<tr>").appendElement(d).appendElement(g).appendElement(m).appendElement(u).appendElement(a).appendElement(c)};
return c}(Bootstrap);a.TaskMgr=c;var k='\n        <div class="dropdown">\n            <a class="btn btn-sm btn-icon-only text-light" href="#" role="button"\n                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"\n                style="box-shadow: none;">\n\n                <i class="fas fa-ellipsis-v"></i>\n            </a>\n            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">\n                <a class="dropdown-item bg-danger" href="#">Delete</a>\n                <a class="dropdown-item" href="{$model_url}">View Model</a>\n                <a class="dropdown-item" href="#">Help</a>\n            </div>\n        </div>\n    ',
h={pending:'<div class="d-flex align-items-center">\n                                            <span class="mr-2">0%</span>\n                                            <div>\n                                                <div class="progress">\n                                                    <div class="progress-bar bg-warning" role="progressbar"\n                                                        aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"\n                                                        style="width: 1%;"></div>\n                                                </div>\n                                            </div>\n                                        </div>',
...
(function(a){(function(a){(function(b){function d(a,b,d,e,l,g,n,r){void 0===l&&(l=10);void 0===g&&(g=!1);void 0===n&&(n=null);void 0===r&&(r=null);var k=$ts(d);k&&(k.clear(),a.populateSuggestion(b,l,g).forEach(function(a){k.appendChild(c(a,r,e))}),isNullOrUndefined(n)||a.hasEquals(b,g)||(a=$ts("<a>",{href:executeJavaScript,text:b,title:b,onclick:function(){n(b)}}).display("add '"+b+"'"),k.append($ts("<div>",{class:r}).display(a))))}function c(a,b,c){var d=$ts("<a>",{href:executeJavaScript,text:a.term,
title:a.term,onclick:function(){c(a)}}).display(a.term);return $ts("<div>",{class:b}).display(d)}b.makeSuggestions=function(b,c,e,m,l,g,n){void 0===m&&(m=10);void 0===l&&(l=!1);void 0===g&&(g=null);void 0===n&&(n=null);var k=new a.suggestion(b);return function(a){d(k,a,c,e,m,l,n,g)}}})(a.render||(a.render={}))})(a.suggestion_list||(a.suggestion_list={}))})(uikit||(uikit={}));
(function(a){(function(a){var b=function(){function b(a){this.terms=a}b.prototype.hasEquals=function(a,b){void 0===b&&(b=!1);b||(a=a.toLowerCase());for(var c=0,d=this.terms;c<d.length;c++){var e=d[c];if(b){if(e.term.toLowerCase()==a)return!0}else if(e.term==a)return!0}return!1};b.prototype.populateSuggestion=function(c,d,e){void 0===d&&(d=5);void 0===e&&(e=!1);var k=c.toLowerCase(),h=$from(this.terms).Select(function(a){var d=b.getScore(a,c,k,e);return{term:a,score:d}}).OrderBy(function(a){return a.score}),
l=h.Where(function(b){return b.score!=a.NA}).Take(d).Select(function(a){return a.term}).ToArray();return l.length==d?l:b.makeAdditionalSuggestion(h,l,e,c,d)};b.makeAdditionalSuggestion=function(a,b,d,e,m){var c=e.toLowerCase();a=a.Skip(b.length).Select(function(a){a=a.term;var b=d?Levenshtein.ComputeDistance(a.term.toLowerCase(),c):Levenshtein.ComputeDistance(a.term,e);return{term:a,score:b}}).OrderBy(function(a){return a.score}).Take(m-b.length).Select(function(a){return a.term}).ToArray();return b.concat(a)};
b.getScore=function(b,d,e,u){return u?(b=b.term.toLowerCase(),a.term.indexOf(b,e)):b.dist(d)};return b}();a.suggestion=b})(a.suggestion_list||(a.suggestion_list={}))})(uikit||(uikit={}));
(function(a){(function(a){a.NA=1E11;var b=function(){function b(a,b){this.id=a;this.term=b}b.prototype.dist=function(a){return b.indexOf(this.term,a)};b.indexOf=function(b,d){return-1==b.indexOf(d)?a.NA:Math.abs(d.length-b.length)};return b}();a.term=b})(a.suggestion_list||(a.suggestion_list={}))})(uikit||(uikit={}));
