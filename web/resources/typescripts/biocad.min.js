...
a.classToFontAwsome=function(a){var k=BioCAD.MIME.bioClassType;return a==k.text?[b(d),"green"]:a==k.image?[b(l),"red"]:a==k.matrix?[b(m),"darkgreen"]:a==k.bioSequence?[b(c),"lightblue"]:[b(g),"gray"]}})(a.bioMimeTypes||(a.bioMimeTypes={}))})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));
(function(a){(function(a){(function(b){function f(a,b,m,g,f,k,e,q){void 0===f&&(f=10);void 0===k&&(k=!1);void 0===e&&(e=null);void 0===q&&(q=null);var d=$ts(m);d&&(d.clear(),a.populateSuggestion(b,f,k).forEach(function(a){d.appendChild(c(a,q,g))}),isNullOrUndefined(e)||a.hasEquals(b,k)||(a=$ts("<a>",{href:executeJavaScript,text:b,title:b,onclick:function(){e(b)}}).display("add '"+b+"'"),d.append($ts("<div>",{class:q}).display(a))))}function c(a,c,b){var d=$ts("<a>",{href:executeJavaScript,text:a.term,
title:a.term,onclick:function(){b(a)}}).display(a.term);return $ts("<div>",{class:c}).display(d)}b.makeSuggestions=function(c,b,m,g,e,k,t){void 0===g&&(g=10);void 0===e&&(e=!1);void 0===k&&(k=null);void 0===t&&(t=null);var d=new a.suggestion(c);return function(a){f(d,a,b,m,g,e,t,k)}}})(a.render||(a.render={}))})(a.Suggestion||(a.Suggestion={}))})(Application||(Application={}));
...
data:Base64.encode(this.csvText)};DOM.download("PLAS_output.csv",a,!1)};c.prototype.initPathwaySelector=function(b){var c=this,d=$ts("#pathway_list"),e=$ts("<optgroup>",{label:"Pathways"}),k=$ts("<optgroup>",{label:"Metabolites"}),f=this.pathways,l=this,u=[];e.appendChild($ts("<option>",{value:"*"}).display("*"));for(var n=0,r=b.nodeDataArray;n<r.length;n++){var h=r[n];if(h.isGroup){var x={pathway:h.label,keys:[]},p=$ts("<option>",{value:h.key}),v=new Application.Suggestion.term(h.key,h.text);p.innerText=
h.text;u.push(v);f.Add(h.key.toString(),x);e.appendChild(p)}}n=0;for(b=b.nodeDataArray;n<b.length;n++)h=b[n],!isNullOrUndefined(h.isGroup)&&h.isGroup||Strings.Empty(h.group,!0)||(r=f.Item(h.group.toString()),p=$ts("<option>",{value:h.label}),v=new Application.Suggestion.term(h.label,h.label),p.innerText=h.label,r.keys.push(h.label),"valve"==h.category||Strings.Empty(h.label,!0)||(u.push(v),k.appendChild(p)));d.add(e);d.add(k);d.onchange=function(){var a=$ts.select.getOption("#pathway_list");isNullOrUndefined(a)||
Strings.Empty(a)||l.updateChart(a.toString())};var y=Application.Suggestion.render.makeSuggestions(u,a.listDiv,function(a){return c.clickOnTerm(a)},5,!0,"");$ts(a.inputDiv).onkeyup=function(){var b=$ts.value(a.inputDiv);Strings.Empty(b,!0)?$ts(a.listDiv).hide():($ts(a.listDiv).show(),y(b))}};c.prototype.clickOnTerm=function(b){$ts.value("#pathway_list",b.id.toString());$ts(a.listDiv).hide();this.updateChart(b.id)};return c}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp=
{}))})(bioCAD||(bioCAD={}));
...
a.sha1+'" target="__blank">\n                                <h4 class="mb-0">'+a.title+"</h4>\n                            </a>                            \n                        </div>")),g=$ts("<td>").appendElement(a.create_time),k=$ts("<td>").appendElement(m[b(a.status)]),l=$ts("<td>").appendElement(a.finish_time||"n/a");a=$ts("<td>").appendElement(e[b(a.status)]);c=$ts("<td>",{class:"text-right"}).appendElement(d.replace("{$model_url}",c));return $ts("<tr>").appendElement(f).appendElement(g).appendElement(k).appendElement(l).appendElement(a).appendElement(c)};
