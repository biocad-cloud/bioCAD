...
d={animation:!1,grid:{top:40,left:50,right:40,bottom:50},xAxis:{name:"Time(ticks)",minorTick:{show:!0},minorSplitLine:{show:!0}},yAxis:{name:"Activity",min:0,max:10,minorTick:{show:!0},minorSplitLine:{show:!0}},series:c};console.log("lines:");console.log(c);d&&b.setOption(d)};b.prototype.init=function(){var a=this,b=document.getElementById("main"),c=echarts.init(b);$ts.getText("@data:PLAS",function(b){return a.makeChart($ts.csv(b,!1),c)})};return b}(Bootstrap);a.Report=b})(a.Platform||(a.Platform=
{}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
