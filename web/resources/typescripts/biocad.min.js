...
console.log.apply(dev,logo);(function(a){(function(a){a.start=function(){Router.AddAppHandler(new a.LoginScript);Router.AddAppHandler(new a.RegisterScript);Router.AddAppHandler(new a.RecoverScript);Router.AddAppHandler(new a.Platform.TaskMgr);Router.RunApp()}})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));$ts.mode=Modes.debug;$ts(bioCAD.WebApp.start);
(function(a){(function(a){(function(a){var b=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"Report"},enumerable:!0,configurable:!0});b.prototype.makeChart=function(a,b){console.log(a);b.setOption({xAxis:{type:"value",data:[]},yAxis:{type:"value"},series:[{data:[820,932,901,934,1290,1330,1320],type:"line",smooth:!0}]})};b.prototype.init=function(){var a=this,b=document.getElementById("main"),
c=echarts.init(b);$ts.getText("data:PLAS",function(b){return a.makeChart($ts.csv(b),c)})};return b}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
...
a.sha1+'" target="__blank">\n                                <h4 class="mb-0">'+a.title+"</h4>\n                            </a>                            \n                        </div>")),e=$ts("<td>").appendElement(a.create_time),k=$ts("<td>").appendElement(h[b(a.status)]),l=$ts("<td>").appendElement(a.finish_time||"n/a");a=$ts("<td>").appendElement(g[b(a.status)]);c=$ts("<td>",{class:"text-right"}).appendElement(f.replace("{$model_url}",c));return $ts("<tr>").appendElement(d).appendElement(e).appendElement(k).appendElement(l).appendElement(a).appendElement(c)};
return c}(Bootstrap);a.TaskMgr=c;var f='\n        <div class="dropdown">\n            <a class="btn btn-sm btn-icon-only text-light" href="#" role="button"\n                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"\n                style="box-shadow: none;">\n\n                <i class="fas fa-ellipsis-v"></i>\n            </a>\n            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">\n                <a class="dropdown-item bg-danger" href="#">Delete</a>\n                <a class="dropdown-item" href="{$model_url}">View Model</a>\n                <a class="dropdown-item" href="#">Help</a>\n            </div>\n        </div>\n    ',
g={pending:'<div class="d-flex align-items-center">\n                                            <span class="mr-2">0%</span>\n                                            <div>\n                                                <div class="progress">\n                                                    <div class="progress-bar bg-warning" role="progressbar"\n                                                        aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"\n                                                        style="width: 1%;"></div>\n                                                </div>\n                                            </div>\n                                        </div>',
