...
this.fileId+'" type="button" class="kv-file-zoom btn btn-sm btn-kv btn-default btn-outline-secondary" title="View Details">\n                            <i class="glyphicon glyphicon-zoom-in"></i>\n                        </button>\n                    </div>\n                </div>'};a.prototype.handleEvents=function(){var a=this;$ts("#view-"+this.fileId).onclick=function(){a.viewer_click()}};a.prototype.viewer_click=function(){$ts("#diag-title").clear().innerText="View Model";$ts("#diag-body").clear().display("");
$ts("#viewer-modal").style.zIndex="1050000";$("#viewer-modal").modal("show")};a.prototype.getNode=function(){var a=this.mimeIcon[0],d=this.mimeIcon[1];a=$ts("<div>",{class:"kv-file-content"}).display($ts("<div>",{class:["kv-preview-data","file-preview-other-frame"],style:"width:auto;height:auto;max-width:100%;max-height:100%;"}).display('\n                <div class="file-preview-other">\n                    <span class="file-other-icon">\n                        <center>\n                            <div style="max-width: 128px; height: 50px; color: '+
d+';">\n                                '+a+"\n                            </div>\n                        </center>\n                    </span>\n                </div>\n            "));d=$ts("<div>",{class:"file-thumbnail-footer"}).appendElement(this.footer()).appendElement(this.actionButtons()).appendElement($ts("<div>",{class:"clearfix"}));return $ts("<div>",{class:["file-preview-frame","krajee-default","file-preview-initial","file-sortable","kv-preview-thumb"],id:"r-"+this.fileId,"data-fileindex":this.fileId,
"data-template":"image",title:this.file.fileName}).appendElement(a).appendElement(d)};a.classNames=["file-preview-frame","krajee-default","file-preview-initial","file-sortable","kv-preview-thumb"];return a}();a.FileHandle=b})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));
