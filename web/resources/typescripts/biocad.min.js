...
ymax:c.Select(function(a){return a[1]}).Max()}}).ToArray(),d={animation:!1,title:"PLAS.NET Systems Dynamics",tooltip:{trigger:"none",axisPointer:{type:"cross"}},legend:{},grid:{top:40,left:50,right:40,bottom:50},xAxis:{name:"Time(ticks)",minorTick:{show:!0},minorSplitLine:{show:!0},nameLocation:"middle"},yAxis:{name:"Activity",min:0,max:$from(c).Select(function(a){return a.ymax}).Max(),minorTick:{show:!0},minorSplitLine:{show:!0}},series:c};console.log("lines:");console.log(c);d&&b.setOption(d)};
