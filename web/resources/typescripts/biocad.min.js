...
t=["0 0 448 512","M448 80v352c0 26.51-21.49 48-48 48H48c-26.51 0-48-21.49-48-48V80c0-26.51 21.49-48 48-48h352c26.51 \n         0 48 21.49 48 48zm-48 346V86a6 6 0 0 0-6-6H54a6 6 0 0 0-6 6v340a6 6 0 0 0 6 6h340a6 6 0 0 0 6-6zm-68.756-225.2c0 \n         67.052-72.421 68.084-72.421 92.863V300c0 6.627-5.373 12-12 12h-45.647c-6.627 0-12-5.373-12-12v-8.659c0-35.745 \n         27.1-50.034 47.579-61.516 17.561-9.845 28.324-16.541 28.324-29.579 0-17.246-21.999-28.693-39.784-28.693-23.189 \n         0-33.894 10.977-48.942 29.969-4.057 5.12-11.46 6.071-16.666 2.124l-27.824-21.098c-5.107-3.872-6.251-11.066-2.644-16.363C152.846 \n         131.491 182.94 112 229.794 112c49.071 0 101.45 38.304 101.45 88.8zM266 368c0 23.159-18.841 42-42 \n         42s-42-18.841-42-42 18.841-42 42-42 42 18.841 42 42z"];
a.classToFontAwsome=function(a){var h=BioCAD.MIME.bioClassType;return a==h.text?[b(g),"green"]:a==h.image?[b(f),"red"]:a==h.matrix?[b(m),"darkgreen"]:a==h.bioSequence?[b(c),"lightblue"]:[b(t),"gray"]}})(a.bioMimeTypes||(a.bioMimeTypes={}))})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));
(function(a){(function(a){(function(b){function e(a,b,m,t,e,h,d,q){void 0===e&&(e=10);void 0===h&&(h=!1);void 0===d&&(d=null);void 0===q&&(q=null);var f=$ts(m);f&&(f.clear(),a.populateSuggestion(b,e,h).forEach(function(a){f.appendChild(c(a,q,t))}),isNullOrUndefined(d)||a.hasEquals(b,h)||(a=$ts("<a>",{href:executeJavaScript,text:b,title:b,onclick:function(){d(b)}}).display("add '"+b+"'"),f.append($ts("<div>",{class:q}).display(a))))}function c(a,b,c){var f=$ts("<a>",{href:executeJavaScript,text:a.term,
title:a.term,onclick:function(){c(a)}}).display(a.term);return $ts("<div>",{class:b}).display(f)}b.makeSuggestions=function(b,c,m,d,l,h,u){void 0===d&&(d=10);void 0===l&&(l=!1);void 0===h&&(h=null);void 0===u&&(u=null);var f=new a.suggestion(b);return function(a){e(f,a,c,m,d,l,u,h)}}})(a.render||(a.render={}))})(a.Suggestion||(a.Suggestion={}))})(Application||(Application={}));
...
data:Base64.encode(this.csvText)};DOM.download("PLAS_output.csv",a,!1)};c.prototype.initPathwaySelector=function(b){var c=this,d=$ts("#pathway_list"),e=$ts("<optgroup>",{label:"Pathways"}),h=$ts("<optgroup>",{label:"Metabolites"}),f=this.pathways,g=this,v=[];e.appendChild($ts("<option>",{value:"*"}).display("*"));for(var n=0,r=b.nodeDataArray;n<r.length;n++){var k=r[n];if(k.isGroup){var x={pathway:k.label,keys:[]},p=$ts("<option>",{value:k.key}),w=new Application.Suggestion.term(k.key,k.text);p.innerText=
k.text;v.push(w);f.Add(k.key.toString(),x);e.appendChild(p)}}n=0;for(b=b.nodeDataArray;n<b.length;n++)k=b[n],!isNullOrUndefined(k.isGroup)&&k.isGroup||Strings.Empty(k.group,!0)||(r=f.Item(k.group.toString()),p=$ts("<option>",{value:k.label}),w=new Application.Suggestion.term(k.label,k.label),p.innerText=k.label,r.keys.push(k.label),"valve"==k.category||Strings.Empty(k.label,!0)||(v.push(w),h.appendChild(p)));d.add(e);d.add(h);d.onchange=function(){var a=$ts.select.getOption("#pathway_list");isNullOrUndefined(a)||
Strings.Empty(a)||g.updateChart(a.toString())};var y=Application.Suggestion.render.makeSuggestions(v,a.listDiv,function(a){return c.clickOnTerm(a)},5,!0,"");$ts(a.inputDiv).onkeyup=function(){var b=$ts.value(a.inputDiv);Strings.Empty(b,!0)?$ts(a.listDiv).hide():($ts(a.listDiv).show(),y(b))}};c.prototype.clickOnTerm=function(b){$ts.value("#pathway_list",b.id.toString());$ts(a.listDiv).hide();this.updateChart(b.id)};return c}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp=
{}))})(bioCAD||(bioCAD={}));
...
a.sha1+'" target="__blank">\n                                <h4 class="mb-0">'+a.title+"</h4>\n                            </a>                            \n                        </div>")),g=$ts("<td>").appendElement(a.create_time),h=$ts("<td>").appendElement(m[b(a.status)]),l=$ts("<td>").appendElement(a.finish_time||"n/a");a=$ts("<td>").appendElement(f[b(a.status)]);c=$ts("<td>",{class:"text-right"}).appendElement(d.replace("{$model_url}",c));return $ts("<tr>").appendElement(e).appendElement(g).appendElement(h).appendElement(l).appendElement(a).appendElement(c)};
