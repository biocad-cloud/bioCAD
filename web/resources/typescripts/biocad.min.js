...
(function(a){(function(a){(function(a){a.listDiv="#sample_suggests";a.inputDiv="#sample_search";var c=function(b){function c(){var a=null!==b&&b.apply(this,arguments)||this;a.pathways=new Dictionary;a.data={y:new IEnumerator([])};return a}__extends(c,b);Object.defineProperty(c.prototype,"appName",{get:function(){return"reportViewer"},enumerable:!0,configurable:!0});c.prototype.updateChart=function(a){var b=this;this.makeChartInternal(function(){if("*"==a)return b.data.y;if(b.pathways.ContainsKey(a)){var c=
b.pathways.Item(a),p=$from(c.keys);return b.data.y.Where(function(a){return p.Any(function(b){return b==a.name})})}return b.data.y.Where(function(b){return a==b.name})}())};c.parseData=function(a){return a.headers.Where(function(a){return""!=a}).Select(function(b){var c=a.Column(b).Skip(1).Select(function(a,b){return[b,parseFloat(a)]});return{name:b,type:"line",smooth:!0,showSymbol:!1,clip:!0,data:c.ToArray(),emphasis:{focus:"series"},ymax:c.Select(function(a){return a[1]}).Max()}})};c.prototype.makeChart=
function(a,b){a=c.parseData(a);this.myChart=b;this.data.y=a;this.makeChartInternal(a);b.on("legendselectchanged",function(a){console.log(a)})};c.prototype.makeChartInternal=function(a){var b=TypeScript.Data.quantile(a.Select(function(a){return a.ymax}).ToArray(),.65),c=this.myChart;b={animation:!1,tooltip:{trigger:"none",axisPointer:{type:"cross"}},legend:{},grid:{top:40,left:50,right:40,bottom:50},xAxis:{name:"Time(ticks)",minorTick:{show:!0},minorSplitLine:{show:!0},nameLocation:"middle"},yAxis:{name:"Activity",
min:0,max:Math.round(1.25*b),minorTick:{show:!0},minorSplitLine:{show:!0}},series:a.ToArray()};console.log("lines:");console.log(a);b&&c.setOption(b,!0,!1)};c.prototype.init=function(){var a=this,b=document.getElementById("main"),c=echarts.init(b);$ts.getText("@data:PLAS",function(b){return a.makeChart($ts.csv(b,!1),c)});$ts.getText("@url:graph",function(b){return a.initPathwaySelector(JSON.parse(b))})};c.prototype.initPathwaySelector=function(b){var c=this,h=$ts("#pathway_list"),e=$ts("<optgroup>",
{label:"Pathways"}),g=$ts("<optgroup>",{label:"Metabolites"}),d=this.pathways,p=this,u=[];e.appendChild($ts("<option>",{value:"*"}).display("*"));for(var n=0,t=b.nodeDataArray;n<t.length;n++){var f=t[n];if(f.isGroup){var x={pathway:f.label,keys:[]},q=$ts("<option>",{value:f.key}),v=new uikit.suggestion_list.term(f.key,f.text);q.innerText=f.text;u.push(v);d.Add(f.key.toString(),x);e.appendChild(q)}}n=0;for(b=b.nodeDataArray;n<b.length;n++)f=b[n],!isNullOrUndefined(f.isGroup)&&f.isGroup||Strings.Empty(f.group,
!0)||(t=d.Item(f.group.toString()),q=$ts("<option>",{value:f.label}),v=new uikit.suggestion_list.term(f.label,f.label),q.innerText=f.label,t.keys.push(f.label),"valve"==f.category||Strings.Empty(f.label,!0)||(u.push(v),g.appendChild(q)));h.add(e);h.add(g);h.onchange=function(){var a=$ts.select.getOption("#pathway_list");isNullOrUndefined(a)||Strings.Empty(a)||p.updateChart(a.toString())};var y=uikit.suggestion_list.render.makeSuggestions(u,a.listDiv,function(a){return c.clickOnTerm(a)},5,!1,"");$ts(a.inputDiv).onkeyup=
function(){var b=$ts.value(a.inputDiv);Strings.Empty(b,!0)?$ts(a.listDiv).hide():($ts(a.listDiv).show(),y(b))}};c.prototype.clickOnTerm=function(b){$ts.value("#pathway_list",b.id.toString());$ts(a.listDiv).hide();this.updateChart(b.id)};return c}(Bootstrap);a.Report=c})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
...
b.prototype.taskRow=function(a){var b=a.app_view+"?guid="+this.getModelId(a),e=$ts("<th>").appendElement($ts("<div>",{class:["media","align-items-center"]}).appendElement('\n                        <a href="#" class="avatar rounded-circle mr-3">\n                            <img alt="Image placeholder"\n                                src="/resources/images/icons/'+a.name+'.png">\n                        </a>').appendElement('\n                        <div class="media-body">\n                            <a href="/task/report/?q='+
a.sha1+'" target="__blank">\n                                <h4 class="mb-0">'+a.title+"</h4>\n                            </a>                            \n                        </div>")),g=$ts("<td>").appendElement(a.create_time),p=$ts("<td>").appendElement(w[c(a.status)]),l=$ts("<td>").appendElement(a.finish_time||"n/a");a=$ts("<td>").appendElement(d[c(a.status)]);b=$ts("<td>",{class:"text-right"}).appendElement(h.replace("{$model_url}",b));return $ts("<tr>").appendElement(e).appendElement(g).appendElement(p).appendElement(l).appendElement(a).appendElement(b)};
...
d={pending:'<div class="d-flex align-items-center">\n                                            <span class="mr-2">0%</span>\n                                            <div>\n                                                <div class="progress">\n                                                    <div class="progress-bar bg-warning" role="progressbar"\n                                                        aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"\n                                                        style="width: 1%;"></div>\n                                                </div>\n                                            </div>\n                                        </div>',
...
(function(a){(function(a){(function(c){function e(a,c,e,d,k,g,m,r){void 0===k&&(k=10);void 0===g&&(g=!1);void 0===m&&(m=null);void 0===r&&(r=null);var h=$ts(e);h&&(h.clear(),a.populateSuggestion(c,k,g).forEach(function(a){h.appendChild(b(a,r,d))}),isNullOrUndefined(m)||a.hasEquals(c,g)||(a=$ts("<a>",{href:executeJavaScript,text:c,title:c,onclick:function(){m(c)}}).display("add '"+c+"'"),h.append($ts("<div>",{class:r}).display(a))))}function b(a,b,c){var e=$ts("<a>",{href:executeJavaScript,text:a.term,
title:a.term,onclick:function(){c(a)}}).display(a.term);return $ts("<div>",{class:b}).display(e)}c.makeSuggestions=function(b,c,d,l,k,g,m){void 0===l&&(l=10);void 0===k&&(k=!1);void 0===g&&(g=null);void 0===m&&(m=null);var h=new a.suggestion(b);return function(a){e(h,a,c,d,l,k,m,g)}}})(a.render||(a.render={}))})(a.suggestion_list||(a.suggestion_list={}))})(uikit||(uikit={}));
