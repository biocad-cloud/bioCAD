...
(function(a){(function(a){(function(a){var b=function(a){function b(){var b=null!==a&&a.apply(this,arguments)||this;b.pathways=new Dictionary;return b}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"reportViewer"},enumerable:!0,configurable:!0});b.prototype.makeChart=function(a,b){var c=a.headers.Where(function(a){return""!=a}).Select(function(b){var c=a.Column(b).Skip(1).Select(function(a,b){return[b,parseFloat(a)]});return{name:b,type:"line",smooth:!0,showSymbol:!1,
clip:!0,data:c.ToArray(),emphasis:{focus:"series"},ymax:c.Select(function(a){return a[1]}).Max()}}),d={animation:!1,tooltip:{trigger:"none",axisPointer:{type:"cross"}},legend:{},grid:{top:40,left:50,right:40,bottom:50},xAxis:{name:"Time(ticks)",minorTick:{show:!0},minorSplitLine:{show:!0},nameLocation:"middle"},yAxis:{name:"Activity",min:0,max:TypeScript.Data.quantile(c.Select(function(a){return a.ymax}).ToArray(),.65),minorTick:{show:!0},minorSplitLine:{show:!0}},series:c.ToArray()};console.log("lines:");
console.log(c);d&&b.setOption(d);b.on("legendselectchanged",function(a){console.log(a)})};b.prototype.init=function(){var a=this,b=document.getElementById("main"),c=echarts.init(b);$ts.getText("@data:PLAS",function(b){return a.makeChart($ts.csv(b,!1),c)});$ts.getText("@url:graph",function(b){return a.initPathwaySelector(JSON.parse(b))})};b.prototype.initPathwaySelector=function(a){for(var b=$ts("#pathway_list"),c=this.pathways,d=0,g=a.nodeDataArray;d<g.length;d++){var e=g[d];if(e.isGroup){var n={pathway:e.label,
keys:[]},f=$ts("<option>",{value:e.key}).display(e.label);c.Add(e.key.toString(),n);b.appendChild(f)}}d=0;for(a=a.nodeDataArray;d<a.length;d++)if(e=a[d],isNullOrUndefined(e.isGroup)||!e.isGroup)Strings.Empty(e.group,!0)||c.Item(e.group.toString()).keys.push(e.label);b.onselectionchange=function(a,b){console.log(b)}};return b}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
...
a.sha1+'" target="__blank">\n                                <h4 class="mb-0">'+a.title+"</h4>\n                            </a>                            \n                        </div>")),f=$ts("<td>").appendElement(a.create_time),g=$ts("<td>").appendElement(m[b(a.status)]),h=$ts("<td>").appendElement(a.finish_time||"n/a");a=$ts("<td>").appendElement(l[b(a.status)]);c=$ts("<td>",{class:"text-right"}).appendElement(k.replace("{$model_url}",c));return $ts("<tr>").appendElement(d).appendElement(f).appendElement(g).appendElement(h).appendElement(a).appendElement(c)};
return c}(Bootstrap);a.TaskMgr=d;var k='\n        <div class="dropdown">\n            <a class="btn btn-sm btn-icon-only text-light" href="#" role="button"\n                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"\n                style="box-shadow: none;">\n\n                <i class="fas fa-ellipsis-v"></i>\n            </a>\n            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">\n                <a class="dropdown-item bg-danger" href="#">Delete</a>\n                <a class="dropdown-item" href="{$model_url}">View Model</a>\n                <a class="dropdown-item" href="#">Help</a>\n            </div>\n        </div>\n    ',
l={pending:'<div class="d-flex align-items-center">\n                                            <span class="mr-2">0%</span>\n                                            <div>\n                                                <div class="progress">\n                                                    <div class="progress-bar bg-warning" role="progressbar"\n                                                        aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"\n                                                        style="width: 1%;"></div>\n                                                </div>\n                                            </div>\n                                        </div>',
