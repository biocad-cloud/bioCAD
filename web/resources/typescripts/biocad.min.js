...
(function(a){(function(a){(function(a){var b=function(a){function b(){var b=null!==a&&a.apply(this,arguments)||this;b.pathways=new Dictionary;b.data={y:new IEnumerator([])};return b}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"reportViewer"},enumerable:!0,configurable:!0});b.prototype.updateChart=function(a){console.log(a);a=this.pathways.Item(a.toString());var b=$from(a.keys);a=this.data.y.Where(function(a){return b.Any(function(b){return b==a.name})});this.makeChartInternal(a)};
b.parseData=function(a){return a.headers.Where(function(a){return""!=a}).Select(function(b){var c=a.Column(b).Skip(1).Select(function(a,b){return[b,parseFloat(a)]});return{name:b,type:"line",smooth:!0,showSymbol:!1,clip:!0,data:c.ToArray(),emphasis:{focus:"series"},ymax:c.Select(function(a){return a[1]}).Max()}})};b.prototype.makeChart=function(a,c){a=b.parseData(a);this.myChart=c;this.data.y=a;c.on("legendselectchanged",function(a){console.log(a)})};b.prototype.makeChartInternal=function(a){var b=
TypeScript.Data.quantile(a.Select(function(a){return a.ymax}).ToArray(),.65),c=this.myChart;b={animation:!1,tooltip:{trigger:"none",axisPointer:{type:"cross"}},legend:{},grid:{top:40,left:50,right:40,bottom:50},xAxis:{name:"Time(ticks)",minorTick:{show:!0},minorSplitLine:{show:!0},nameLocation:"middle"},yAxis:{name:"Activity",min:0,max:b,minorTick:{show:!0},minorSplitLine:{show:!0}},series:a.ToArray()};console.log("lines:");console.log(a);b&&c.setOption(b)};b.prototype.init=function(){var a=this,
b=document.getElementById("main"),c=echarts.init(b);$ts.getText("@data:PLAS",function(b){return a.makeChart($ts.csv(b,!1),c)});$ts.getText("@url:graph",function(b){return a.initPathwaySelector(JSON.parse(b))})};b.prototype.initPathwaySelector=function(a){for(var b=$ts("#pathway_list"),c=this.pathways,d=this,g=0,k=a.nodeDataArray;g<k.length;g++){var e=k[g];if(e.isGroup){var f={pathway:e.label,keys:[]},l=$ts("<option>",{value:e.key});l.innerText=e.text;c.Add(e.key.toString(),f);b.add(l)}}g=0;for(a=
a.nodeDataArray;g<a.length;g++)if(e=a[g],isNullOrUndefined(e.isGroup)||!e.isGroup)Strings.Empty(e.group,!0)||c.Item(e.group.toString()).keys.push(e.label);b.onchange=function(){d.updateChart($ts.select.getOption("#pathway_list"))}};return b}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
...
a.sha1+'" target="__blank">\n                                <h4 class="mb-0">'+a.title+"</h4>\n                            </a>                            \n                        </div>")),f=$ts("<td>").appendElement(a.create_time),g=$ts("<td>").appendElement(p[b(a.status)]),h=$ts("<td>").appendElement(a.finish_time||"n/a");a=$ts("<td>").appendElement(n[b(a.status)]);c=$ts("<td>",{class:"text-right"}).appendElement(m.replace("{$model_url}",c));return $ts("<tr>").appendElement(d).appendElement(f).appendElement(g).appendElement(h).appendElement(a).appendElement(c)};
