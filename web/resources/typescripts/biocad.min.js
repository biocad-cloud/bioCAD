...
var __extends=this&&this.__extends||function(){var a=function(b,d){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,c){a.__proto__=c}||function(a,c){for(var g in c)c.hasOwnProperty(g)&&(a[g]=c[g])};return a(b,d)};return function(b,d){function e(){this.constructor=b}a(b,d);b.prototype=null===d?Object.create(d):(e.prototype=d.prototype,new e)}}(),bioCAD;
...
(function(a){(function(a){a.show=function(b,e,c){var g=$ts(b),f=$from(c).ToDictionary(function(a){return a.contentType},function(a){return a.class});e=$from(e).Select(function(c){var b=f.Item(c.mime.contentType);b=a.bioMimeTypes.classToFontAwsome(b);return new a.FileHandle(c,b)});g.classList.contains(containerClassName)||g.classList.add(containerClassName);g.innerHTML=e.Select(function(a){return a.toString()}).JoinBy("\n\n");return{container:g,files:e.ToArray(),divId:b}}})(a.Explorer||(a.Explorer=
{}))})(Application||(Application={}));(function(a){(function(a){var b=function(){function a(a,b){this.id=a.id;this.fileName=a.name;this.size=a.size;this.mime=b.Item(a.content_type)}a.prototype.toString=function(){return this.fileName};return a}();a.bioCADFile=b})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));
(function(a){(function(a){var b=function(){function a(a,b){this.file=a;this.mimeIcon=b}Object.defineProperty(a.prototype,"fileId",{get:function(){return this.file.id.toString()},enumerable:!0,configurable:!0});a.prototype.footer=function(){return'<div class="file-footer-caption" title="'+this.file.fileName+'">\n                    <div class="file-caption-info">'+this.file.fileName+'</div>\n                    <div class="file-size-info">\n                        <samp>('+this.file.size+")</samp>\n                    </div>\n                </div>"};
...
a.prototype.toString=function(){return'<div class="file-preview-frame krajee-default file-preview-initial file-sortable kv-preview-thumb" \n                     id="'+this.fileId+'" \n                     data-fileindex="'+this.fileId+'" \n                     data-template="image"\n                     title="'+this.file.fileName+'">\n\n                    <div class="kv-file-content">\n                        <div class="kv-preview-data file-preview-other-frame" style="width:auto;height:auto;max-width:100%;max-height:100%;">\n                            <div class="file-preview-other">\n                                <span class="file-other-icon">\n                                    <center>\n                                        <div style="max-width: 128px; height: 50px; color: '+
this.mimeIcon[1]+';">\n                                            '+this.mimeIcon[0]+'\n                                        </div>\n                                    </center>\n                                </span>\n                            </div>\n                        </div>\n                    </div>\n\n                    <div class="file-thumbnail-footer">\n                        '+this.footer()+"\n                        "+this.actionButtons()+'\n\n                        <div class="clearfix"></div>\n                    </div>\n                </div>'};
a.classNames=["file-preview-frame","krajee-default","file-preview-initial","file-sortable","kv-preview-thumb"];return a}();a.FileHandle=b})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));
...
g=["0 0 384 512","M288 248v28c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-28c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 \n         12 12zm-12 72H108c-6.6 0-12 5.4-12 12v28c0 6.6 5.4 12 12 12h168c6.6 0 12-5.4 12-12v-28c0-6.6-5.4-12-12-12zm108-188.1V464c0 \n         26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V48C0 21.5 21.5 0 48 0h204.1C264.8 0 277 5.1 286 \n         14.1L369.9 98c9 8.9 14.1 21.2 14.1 33.9zm-128-80V128h76.1L256 51.9zM336 464V176H232c-13.3 \n         0-24-10.7-24-24V48H48v416h288z"],f=["0 0 384 512",
"M369.9 97.9L286 14C277 5 264.8-.1 252.1-.1H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h288c26.5 0 \n         48-21.5 48-48V131.9c0-12.7-5.1-25-14.1-34zM332.1 128H256V51.9l76.1 76.1zM48 464V48h160v104c0 13.3 \n         10.7 24 24 24h104v288H48zm32-48h224V288l-23.5-23.5c-4.7-4.7-12.3-4.7-17 0L176 352l-39.5-39.5c-4.7-4.7-12.3-4.7-17 \n         0L80 352v64zm48-240c-26.5 0-48 21.5-48 48s21.5 48 48 48 48-21.5 48-48-21.5-48-48-48z"],n=["0 0 384 512","M369.9 97.9L286 14C277 5 264.8-.1 252.1-.1H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h288c26.5 0 \n         48-21.5 48-48V131.9c0-12.7-5.1-25-14.1-34zM332.1 128H256V51.9l76.1 76.1zM48 464V48h160v104c0 13.3 \n         10.7 24 24 24h104v288H48zm212-240h-28.8c-4.4 0-8.4 2.4-10.5 6.3-18 33.1-22.2 42.4-28.6 57.7-13.9-29.1-6.9-17.3-28.6-57.7-2.1-3.9-6.2-6.3-10.6-6.3H124c-9.3 \n         0-15 10-10.4 18l46.3 78-46.3 78c-4.7 8 1.1 18 10.4 18h28.9c4.4 0 8.4-2.4 10.5-6.3 21.7-40 23-45 \n         28.6-57.7 14.9 30.2 5.9 15.9 28.6 57.7 2.1 3.9 6.2 6.3 10.6 6.3H260c9.3 0 15-10 10.4-18L224 320c.7-1.1 \n         30.3-50.5 46.3-78 4.7-8-1.1-18-10.3-18z"],
w=["0 0 448 512","M448 80v352c0 26.51-21.49 48-48 48H48c-26.51 0-48-21.49-48-48V80c0-26.51 21.49-48 48-48h352c26.51 \n         0 48 21.49 48 48zm-48 346V86a6 6 0 0 0-6-6H54a6 6 0 0 0-6 6v340a6 6 0 0 0 6 6h340a6 6 0 0 0 6-6zm-68.756-225.2c0 \n         67.052-72.421 68.084-72.421 92.863V300c0 6.627-5.373 12-12 12h-45.647c-6.627 0-12-5.373-12-12v-8.659c0-35.745 \n         27.1-50.034 47.579-61.516 17.561-9.845 28.324-16.541 28.324-29.579 0-17.246-21.999-28.693-39.784-28.693-23.189 \n         0-33.894 10.977-48.942 29.969-4.057 5.12-11.46 6.071-16.666 2.124l-27.824-21.098c-5.107-3.872-6.251-11.066-2.644-16.363C152.846 \n         131.491 182.94 112 229.794 112c49.071 0 101.45 38.304 101.45 88.8zM266 368c0 23.159-18.841 42-42 \n         42s-42-18.841-42-42 18.841-42 42-42 42 18.841 42 42z"];
a.classToFontAwsome=function(a){var h=BioCAD.MIME.bioClassType;return a==h.text?[b(g),"green"]:a==h.image?[b(f),"red"]:a==h.matrix?[b(n),"darkgreen"]:a==h.bioSequence?[b(c),"lightblue"]:[b(w),"gray"]}})(a.bioMimeTypes||(a.bioMimeTypes={}))})(a.Explorer||(a.Explorer={}))})(Application||(Application={}));
(function(a){(function(a){(function(b){function e(a,b,n,e,d,h,m,r){void 0===d&&(d=10);void 0===h&&(h=!1);void 0===m&&(m=null);void 0===r&&(r=null);var f=$ts(n);f&&(f.clear(),a.populateSuggestion(b,d,h).forEach(function(a){f.appendChild(c(a,r,e))}),isNullOrUndefined(m)||a.hasEquals(b,h)||(a=$ts("<a>",{href:executeJavaScript,text:b,title:b,onclick:function(){m(b)}}).display("add '"+b+"'"),f.append($ts("<div>",{class:r}).display(a))))}function c(a,b,c){var f=$ts("<a>",{href:executeJavaScript,text:a.term,
title:a.term,onclick:function(){c(a)}}).display(a.term);return $ts("<div>",{class:b}).display(f)}b.makeSuggestions=function(b,c,n,d,l,h,m){void 0===d&&(d=10);void 0===l&&(l=!1);void 0===h&&(h=null);void 0===m&&(m=null);var f=new a.suggestion(b);return function(a){e(f,a,c,n,d,l,m,h)}}})(a.render||(a.render={}))})(a.Suggestion||(a.Suggestion={}))})(Application||(Application={}));
(function(a){(function(a){var b=function(){function b(a){this.terms=a}b.prototype.hasEquals=function(a,b){void 0===b&&(b=!1);b||(a=a.toLowerCase());for(var c=0,g=this.terms;c<g.length;c++){var d=g[c];if(b){if(d.term.toLowerCase()==a)return!0}else if(d.term==a)return!0}return!1};b.prototype.populateSuggestion=function(c,g,f){void 0===g&&(g=5);void 0===f&&(f=!1);var d=c.toLowerCase(),e=$from(this.terms).Select(function(a){var h=b.getScore(a,c,d,f);return{term:a,score:h}}).OrderBy(function(a){return a.score}),
l=e.Where(function(b){return b.score!=a.NA}).Take(g).Select(function(a){return a.term}).ToArray();return l.length==g?l:b.makeAdditionalSuggestion(e,l,f,c,g)};b.makeAdditionalSuggestion=function(a,b,f,d,e){var c=d.toLowerCase();a=a.Skip(b.length).Select(function(a){a=a.term;var b=f?Levenshtein.ComputeDistance(a.term.toLowerCase(),c):Levenshtein.ComputeDistance(a.term,d);return{term:a,score:b}}).OrderBy(function(a){return a.score}).Take(e-b.length).Select(function(a){return a.term}).ToArray();return b.concat(a)};
b.getScore=function(b,d,f,e){return e?(b=b.term.toLowerCase(),a.term.indexOf(b,f)):b.dist(d)};return b}();a.suggestion=b})(a.Suggestion||(a.Suggestion={}))})(Application||(Application={}));
...
(function(a){(function(a){(function(a){var b=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}__extends(b,a);Object.defineProperty(b.prototype,"appName",{get:function(){return"FileExplorer"},enumerable:!0,configurable:!0});b.prototype.init=function(){var a=this;$ts.get("@data:bio_mimetype",function(b){0!=b.code?console.error(b):(a.version=b.info.version,a.mimes=b.info.content_types,a.loadFiles(a.mimes))})};b.prototype.loadFiles=function(a){var b=this;$ts.get("@data:fetch?page=1",
function(c){0!=c.code?console.error(c):b.explorer=Application.Explorer.show("#file-explorer-display",c.info,a)})};return b}(Bootstrap);a.FileManager=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp={}))})(bioCAD||(bioCAD={}));
...
data:Base64.encode(this.csvText)};DOM.download("PLAS_output.csv",a,!1)};c.prototype.initPathwaySelector=function(b){var c=this,d=$ts("#pathway_list"),e=$ts("<optgroup>",{label:"Pathways"}),h=$ts("<optgroup>",{label:"Metabolites"}),f=this.pathways,g=this,u=[];e.appendChild($ts("<option>",{value:"*"}).display("*"));for(var p=0,t=b.nodeDataArray;p<t.length;p++){var k=t[p];if(k.isGroup){var x={pathway:k.label,keys:[]},q=$ts("<option>",{value:k.key}),v=new Application.Suggestion.term(k.key,k.text);q.innerText=
k.text;u.push(v);f.Add(k.key.toString(),x);e.appendChild(q)}}p=0;for(b=b.nodeDataArray;p<b.length;p++)k=b[p],!isNullOrUndefined(k.isGroup)&&k.isGroup||Strings.Empty(k.group,!0)||(t=f.Item(k.group.toString()),q=$ts("<option>",{value:k.label}),v=new Application.Suggestion.term(k.label,k.label),q.innerText=k.label,t.keys.push(k.label),"valve"==k.category||Strings.Empty(k.label,!0)||(u.push(v),h.appendChild(q)));d.add(e);d.add(h);d.onchange=function(){var a=$ts.select.getOption("#pathway_list");isNullOrUndefined(a)||
Strings.Empty(a)||g.updateChart(a.toString())};var y=Application.Suggestion.render.makeSuggestions(u,a.listDiv,function(a){return c.clickOnTerm(a)},5,!0,"");$ts(a.inputDiv).onkeyup=function(){var b=$ts.value(a.inputDiv);Strings.Empty(b,!0)?$ts(a.listDiv).hide():($ts(a.listDiv).show(),y(b))}};c.prototype.clickOnTerm=function(b){$ts.value("#pathway_list",b.id.toString());$ts(a.listDiv).hide();this.updateChart(b.id)};return c}(Bootstrap);a.Report=b})(a.Platform||(a.Platform={}))})(a.WebApp||(a.WebApp=
{}))})(bioCAD||(bioCAD={}));
...
c.prototype.taskRow=function(a){var c=a.app_view+"?guid="+this.getModelId(a),e=$ts("<th>").appendElement($ts("<div>",{class:["media","align-items-center"]}).appendElement('\n                        <a href="#" class="avatar rounded-circle mr-3">\n                            <img alt="Image placeholder"\n                                src="/resources/images/icons/'+a.name+'.png">\n                        </a>').appendElement('\n                        <div class="media-body">\n                            <a href="/task/report/?q='+
a.sha1+'" target="__blank">\n                                <h4 class="mb-0">'+a.title+"</h4>\n                            </a>                            \n                        </div>")),g=$ts("<td>").appendElement(a.create_time),h=$ts("<td>").appendElement(n[b(a.status)]),l=$ts("<td>").appendElement(a.finish_time||"n/a");a=$ts("<td>").appendElement(f[b(a.status)]);c=$ts("<td>",{class:"text-right"}).appendElement(d.replace("{$model_url}",c));return $ts("<tr>").appendElement(e).appendElement(g).appendElement(h).appendElement(l).appendElement(a).appendElement(c)};
...
f={pending:'<div class="d-flex align-items-center">\n                                            <span class="mr-2">0%</span>\n                                            <div>\n                                                <div class="progress">\n                                                    <div class="progress-bar bg-warning" role="progressbar"\n                                                        aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"\n                                                        style="width: 1%;"></div>\n                                                </div>\n                                            </div>\n                                        </div>',
