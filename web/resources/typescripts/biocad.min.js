...
{src:"@view:model?guid="+this.fileId+"&iframe=true",width:"1400px",height:"650px"}));$ts("#viewer-modal").style.zIndex="1050000";$("#viewer-modal").modal("show")};a.prototype.getNode=function(){var a=this.mimeIcon[0],d=this.mimeIcon[1];a=$ts("<div>",{class:"kv-file-content"}).display($ts("<div>",{class:["kv-preview-data","file-preview-other-frame"],style:"width:auto;height:auto;max-width:100%;max-height:100%;"}).display('\n                <div class="file-preview-other">\n                    <span class="file-other-icon">\n                        <center>\n                            <div style="max-width: 128px; height: 50px; color: '+
